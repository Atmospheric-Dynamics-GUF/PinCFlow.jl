...
&domain
  ...
  sizeX = 40 !32 !32 !16 !32 !8 !64,                  ! nb of global grid cells
  sizeY = 160!256 !64 !512, !FS
  sizeZ = 40 !30 !80 !240 !240,
  nbx = 2,                  ! nb. of ghost cells
  nby = 2,
  nbz = 2,
  lx_dim =    0.0, 0.6e7 ! domain lenths in m
  ly_dim =    -1.2e7, 1.2e7 !-2.0e7,2.0e7
  lz_dim =    0.0, 3.e4!13.5e4!10.e4
...
&solverList
  ...
  turb_dts = 52083333.!5.e3       ! (s) turbulent damping time scale for the 
...
&poissonSolverList
  ...
  tolPoisson = 1.e-6!1.0e-8          ! abort criterion
...
&atmosphereList
  ...
  tpdiffhor_tropo_dim = 60! tropospheric temperature difference 
                                 ...
                                 ! (used by HeldSuarez)
  ptdiffvert_tropo_dim = 5.!10.     ! vertical potential-temperature 
...
&boundaryList
  ...
  spongeAlphaZ_fac = 0.01!0.5 ! relaxation rate coeff in 1/dt 
...
&outputList
  ...
  outputTimeDiff = 86400. !3.6e3 !8.64e4 !43200.!5.e4   ! output every ... seconds
  maxTime = 5.184e6 !5.184e6!3.e6!2.5e6 !6.e6 !1.e5 !3.e6           ! stop after maxTime seconds
...
&baroclinic_LC
  ...
  ta_hs_dim = 3456000.!864000.!3456000.!777600.!8.64e5!3.456e6   ! thermal-relaxation time scale outside 
  ...
  jwdth_dim = 4.e6 !2.1e6              ! half (!) jet width (m)

  add_ptptb = .false.            ! add local potential-temperature 
                                ! perturbation
  ptptb_x_dim = 2.5e6           ! x coordinate of local 
                                ! potential-temperature perturbation (m)
  ptptb_y_dim = 5.e6           ! y coordinate of local 
                                ! potential-temperature perturbation (m)
  ...
  ptptb_dz_dim = 4.e3!         ! vertical width of local 
                                ! potential-temperature perturbation  (m)
  ptptb_amp_dim = 1.           ! amplitute of local potential-temperature 
                                ! perturbation (K)
  ...
  add_noise = .true.           ! add noise to the initial potential 
                                ! temperature
  proc_noise = 0.001             ! amplitude of noise is 
                                ! proc_noise*theta_tr_dim
  dTh_atm = 60. !30.                 ! K, potential temperature deviation 
