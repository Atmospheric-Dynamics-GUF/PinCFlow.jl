...
\begin{document}
    \begin{tikzpicture}[mindmap, grow cyclic, line width = 2pt, execute at begin node = ~\textsf, every node/.style = {concept, fill = white}, level 1/.append style = {sibling angle = 72, level distance = 4.5cm}, level 2/.append style = {sibling angle = 45, level distance = 3.1cm}, level 3/.append style = {sibling angle = 45, level distance = 2.1cm}]
        \node {PinCFlow.jl}
