...
contains
  ...
  subroutine initialise (var)
    ...
    real  :: dpdy, dpsidy, T0_s, DgDy_tr, Ly_end, Lx_end, bar_sigma_x, sigma
...
!---------------------------------------------------------------
    ...
    case( "monochromeWave" ) 
       ...
       !----------------------------------------------------------
         ...
         case( 'wavePacket_old' )              ! 1D/2D wave packet
...
!---------------------------------------------------------------
    ...
    case( 'mountainwave' )  
       ...
       var(:,:,:,2) = backgroundFlow_dim(1)!0.0 ! u
       var(:,:,:,3) = backgroundFlow_dim(2)!0.0 ! v
       var(:,:,:,4) = backgroundFlow_dim(3)!0.0 ! w
 ...
 case( 'flowoverahill' )  
    ...
    case( 'raytracer' )
       ...
       var(:,:,:,2) = backgroundFlow_dim(1)/uRef!0.0 ! u
       var(:,:,:,3) = backgroundFlow_dim(2)/uRef!0.0 ! v
       var(:,:,:,4) = backgroundFlow_dim(3)/uRef!0.0 ! w
          ...
          do j = 1,ny
             do i = 1,nx
                ...
                if( r<=1.0 ) then          ! inside bubble
                   ...
                   the_env_pp(i,j,k) = dTheta_dim / thetaRef
