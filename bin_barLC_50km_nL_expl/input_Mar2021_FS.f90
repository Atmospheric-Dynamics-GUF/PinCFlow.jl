...
&boundaryList
  ...
  spongeHeight = 0.33!0.2      ! relative height of sponge layer
  spongeAlphaZ_dim = 250.!5.e-4 !1.4e-4 !2.8e-4 !1.7e-3 ! relaxation rate coeff in 1/s
  spongeAlphaZ_fac = 0.5!2. ! relaxation rate coeff in 1/dt 
...
&baroclinic_LC
  ...
  jwdth_dim = 2.1e6              ! half (!) jet width (m)
  ...
  ptptb_y_dim = 10.e6!5.e6           ! y coordinate of local 
                                ! potential-temperature perturbation (m)
  ptptb_z_dim = 11.e3           ! z coordinate of local 
                                ! potential-temperature perturbation (m)
  ptptb_dh_dim = 10.e5           ! horizontal width of local 
                                ! potential-temperature perturbation  (m)
  ptptb_dz_dim = 4.e3!         ! vertical width of local 
                                ! potential-temperature perturbation  (m)
  ptptb_amp_dim = 0.1!1.           ! amplitute of local potential-temperature 
                                ! perturbation (K)
