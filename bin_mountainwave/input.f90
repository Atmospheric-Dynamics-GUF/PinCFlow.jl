...
&domain
  ...
  sizeX = 200 !256 !128 !256 !1024,                  ! nb of global grid cells
  sizeY = 1,
  sizeZ = 100 !512 !256 !512 !2048,
  nbx = 2,                  ! nb. of ghost cells
  nby = 2,
  nbz = 2,
  lx_dim =   -50000.0, 50000.!5.e6, ! domain lenths in m
  ly_dim =   0.0, 1000.!5.e4,
  lz_dim =   -500., 29500.!30000.!99500,
...
&solverList
  ...
  dtMax_dim = 8!3.6e3               ! max time step in s
...
&poissonSolverList
  ...
  tolPoisson = 1.0e-5          ! abort criterion
...
&atmosphereList
  ...
  N_BruntVaisala_dim = 0.01!1.8-2     ! Brunt-Vaisala frequency for 
...
&topographyList
  ...
  mountainHeight_dim = 250. ! in m
  mountainWidth_dim = 4000.!1.e6  ! m
                            ! shape of orography
  mountain_case = 3         ! 1 for not-shifted single mountain, 
...
&boundaryList
  ...
  spongeAlphaZ_fac = 2. ! relaxation rate coeff in 1/dt 
...
&outputList
  ...
  outputTimeDiff = 225   ! output every ... seconds
  maxTime = 2250         ! stop after maxTime seconds
