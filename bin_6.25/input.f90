...
&domain
  ...
  sizeX = 4096,!2048, !1 !16,                  ! nb of global grid cells
  sizeY = 1, !64,!48,!64,
  sizeZ = 512,!256,
  ...
  ly_dim =   0, 12.5!-1.5e7, 1.5e7!-2.e7, 2.e7
  lz_dim =    0.0,  6400.
...
&solverList
  ...
  dtMax_dim = 1!2!1000!3600               ! max time step in s
  ...
  limiterType1 = "minmod"      ! minmod / Cada / MCVariant
  ...
  turb_dts = 2.083333!5.e3            ! (s) turbulent damping time scale for the 
