...
&domain
  ...
  sizeX = 16, !1 !16,                  ! nb of global grid cells
  sizeY = 64, !64,!48,!64,
  sizeZ = 128,
  ...
  ly_dim =   -1.0e7, 1.0e7!-1.5e7, 1.5e7!-2.e7, 2.e7
  lz_dim =    0.0, 12.e4
...
&solverList
  ...
  dtMax_dim = 1000!3600               ! max time step in s
  ...
  shap_dts_dim = 5.e3 !0. !5.e3             ! horizontal-Shapro-filter damping time 
...
&boundaryList
  ...
  spongeLayer = .true. !.false.     ! sponge with relaxation to background
...
&outputList
  ...
  outputTimeDiff =  1.e4!5.e4   ! output every ... seconds
  maxTime = 2.5e6!2.5e6 !6.e6 !1.e5 !3.e6           ! stop after maxTime seconds
...
&baroclinic_LC
  ...
  jwdth_dim = 2.1e6!5.e6             ! half (!) jet width (m)
  ...
  ptptb_z_dim = 9.e3            ! z coordinate of local 
                                ! potential-temperature perturbation (m)
  ptptb_dh_dim = 10.e5!6.e5           ! horizontal width of local 
                                ! potential-temperature perturbation  (m)
