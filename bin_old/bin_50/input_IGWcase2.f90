...
&domain
  ...
  sizeX = 300, !1 !16,                  ! nb of global grid cells
  sizeY = 1, !64,!48,!64,
  sizeZ = 10,
  nbx = 2,                  ! nb. of ghost cells
  nby = 2,
  nbz = 2,
  lx_dim =    -3000000., 3000000.!0., 6000000. ! domain lenths in m
  ly_dim =   0, 20000.!-1.5e7, 1.5e7!-2.e7, 2.e7
  lz_dim =    0.0,  10000.
...
&poissonSolverList
  ...
  tolPoisson = 1.0e-8  !1.0e-4        ! abort criterion
...
&outputList
  ...
  outputTimeDiff =  60000.   ! output every ... seconds
  maxTime =  60000.           ! stop after maxTime seconds
