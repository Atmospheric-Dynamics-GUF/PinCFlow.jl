...
&topographyList
  ...
  spongeTFC = .false.        ! switch for unified sponge layer
  lateralSponge = .false.    ! switch for lateral sponge layers
  mountainHeight_dim = 5.0e2 ! mountain height in m
  mountainWidth_dim = 1.0e6  ! mountain half-width in m
  mountain_case = 6          ! shape of orography
...
&testCaseList
  ...
  testCase = "raytracer"    ! Boussinesq: uniform_theta, wavePacket
...
&LagrangeRayTracing
  ...
  yr0_dim = 2.0e4,      ! center of the wave packet in hor. (y-dir.) (m)
  zr0_dim = 3.0e4,      ! center of the wave packet in vertical (m)
  ...
  long_scaling = .true. ! Long number scaling for displacement
  long_fit = 0          ! Fit function for Long number scaling (0 = constant
                        ! scaling, 1 = exponential scaling, 2 = nonlinear
                        ! scaling)
  along = 0.4           ! First parameter of the fit function
  blong = 1.0           ! Second paramter of the fit function
