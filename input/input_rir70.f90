...
&variables
  ...
  include_testoutput =  .true. 
  include_testoutput_2 = .true. ! test output
&end
...
&outputList
  ...
  maxTime = 12.0          ! stop after maxTime seconds
...
&wavePacket
  ...
  zCenter_dim = 8.0e3      ! center of wave packet in z direction in m
