...
lambdaX_dim = 2.e3      ! wave length in x direction in m
...
xrmax_dim = 2.e3,        ! right bound of initial rays (in x dir.) (m)
...
zrmax_dim = 10.e3,        ! top bound of initial rays (m)
...
nsmth_wkb = 3,           ! half (number -1) of cells f. smooth. wkb fluxes
...
amp_wkb = 0.95            ! amplitude of the wave packet (wrt saturation)

wlrx_init = 2.e3,        ! initial lambda_x of the wave packet (m)
...
sigwpy_dim = 0.e0        ! width of the wave packet in hor. (y-dir.) (m);
                         ! (0 means infinity)
sigwpz_dim = 2.e4,       ! width of the wave packet in vertical (m);
