...
&outputList
  ...
  maxIter                  =                       1 ! Stop after maxIter time
                                                     ...
                                                     ! 'timeStep'
  outputTimeDiff           =                   100.0 ! Output every
                                                     ! outputTimeDiff seconds
                                                     ! for outputType = 'time'
  maxTime                  =                  4800.0 ! Stop after maxTime
...
&wavePacket
  ...
  amplitudeFactor          =                 1.90E-1 ! Normalized buoyancy
                                                     ! amplitude
  x0_dim                   =                  5.0E+3 ! Wave-packet center in x
  y0_dim                   =                  5.0E+3 ! Wave-packet center in y
  z0_dim                   =                  8.0E+3 ! Wave-packet center in z
...
&LagrangeRayTracing
  xrmin_dim                =                  0.0E+0 ! Left bound of initial
                                                     ! rays
  xrmax_dim                =                 10.0E+3 ! Right bound of initial
                                                     ! rays
  yrmin_dim                =                  0.0E+0 ! Backward bound of
                                                     ! initial rays
  yrmax_dim                =                 10.0E+3 ! Forward bound of initial
                                                     ! rays
  zrmin_dim                =                  0.0E+3 ! Bottom bound of initial
                                                     ! rays
  zrmax_dim                =                 15.0E+3 ! Top bound of initial rays
  ...
  fac_dm_init              =                  1.6E-3 ! Initial fraction dm/m
