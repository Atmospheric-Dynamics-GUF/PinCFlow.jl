...
&topographyList
  ...
  testTFC = .true.          ! switch for TFC test
  spongeTFC = .false.       ! switch for unified sponge layer
  lateralSponge = .false.   ! switch for lateral sponge layers
  mountainHeight_dim = 0.e2 ! mountain height in m
  mountainWidth_dim = 1.5e3 ! mountain half-width in m
...
&boundaryList
  ...
  spongeAlphaZ_dim = 0.1 !1.4e-4 ! relaxation rate coeff in 1/s
