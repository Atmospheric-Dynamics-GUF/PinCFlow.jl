...
&atmosphereList
  ...
  N_BruntVaisala_dim = 0.01414 !0.01            ! Brunt-Vaisala frequency for
                                       ! 1) "const-N" atmosphere in 1/s
                                       ! 2) "unifrom" Boussinesq
  backgroundFlow_dim = 10.0, 10.0, 0.0   ! m/s
...
&topographyList
  ...
  mountainWidth_dim = 28.28e3 ! mountain half-width in m
  mountain_case = 2         ! shape of orography
