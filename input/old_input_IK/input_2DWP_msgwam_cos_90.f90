...
&domain
  ...
  sizeX = 1,!96, !64, !                ! nb of global grid cells
  sizeY = 32,
  sizeZ = 100,!300!, 200, ! 
  nbx = 2,                  ! nb. of ghost cells
  nby = 2,
  nbz = 2,
  lx_dim =   0.0, 3.e5, ! domain lenths in m
  ly_dim =   0.0, 9.e6,
  lz_dim =   0.0, 1.e5,
...
&LagrangeRayTracing
  ...
  xrmax_dim = 3.e5,        ! right bound of initial rays (in x dir.) (m)
  yrmin_dim = 0.0,         ! left bound of initial rays (in y direction) (m)
  yrmax_dim = 9.e6,        ! right bound of initial rays (in y dir.) (m)
  ...
  xr0_dim = 1.5e4,          ! center of the wave packet in hor. (x-dir.) (m)
  yr0_dim = 4.5e6,          ! center of the wave packet in hor. (y-dir.) (m)
  zr0_dim = 3.e4,          ! center of the wave packet in vertical (m)

  sigwpx_dim = 0.e0 ,      ! width of the wave packet in hor. (x-dir.) (m);
                           ! (0 means infinity)
  sigwpy_dim = 1.5e6,       ! width of the wave packet in hor. (y-dir.) (m);
                           ! (0 means infinity)
