...
&outputList
  ...
  outputTimeDiff           =                     100 ! Output every
                                                     ...
                                                     ! for outputType = 'time'
  maxTime                  =                     100 ! Stop after maxTime
...
&LagrangeRayTracing
  xrmin_dim                =                  0.0E+0 ! Left bound of initial
                                                     ! rays
  xrmax_dim                =                 40.0E+3 ! Right bound of initial
                                                     ! rays
  ...
  case_wkb                 =                       5 ! 1 = Gaussian wave
                                                     ! packet, 2 = cosine wave
                                                     ! packet, 3 = mountain
                                                     ! wave, 5 = wave+ice 
  amp_wkb                  =                  1.9E-1 ! Relative amplitude of
                                                     ! wave packet
  wlrx_init                =                  1.0E+4 ! Wavelength in x of wave
                                                     ! packet
...
&iceList
  ...
  inQv                     =                       0 ! ...
  nVarIce                  =                       0 ! ...
  dt_ice                   =                  1.0E+0 ! ice physics integration
  no_ice_source            =                       F ! ...
&end
