...
&outputList
  ...
  outputTimeDiff =  10.0!60.0  ! output every ... seconds
  maxTime = 10.0!18000.0          ! stop after maxTime seconds
...
lambdaY_dim = 0.5e3       ! wave length in y direction in m
...
xCenter_dim = 5.e3     ! center of wave packet in x direction in m
...
sigma_hor_dim = 2.e3     ! cosine distribution width
