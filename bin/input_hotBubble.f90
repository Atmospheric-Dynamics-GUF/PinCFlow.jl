...
&outputList
	...
	nOutput = 1            ! output every nOutput's time step for outputType = "timeStep"
	maxIter = 100000       ! stop after maxIter time steps
...
&testCaseList
	...
	zCenter_dim = 0.0 !m
        ...
        backgroundFlow_dim = 10.0, 0., 0. ! m/2     ! horizontal background flow velocity (along x)
