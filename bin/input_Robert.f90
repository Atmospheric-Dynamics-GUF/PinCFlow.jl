...
&solverList
	...
	dtMax_dim = 5 !s                  ! max time step in s
...
&outputList
	...
	outputTimeDiff =  15  !s    ! output every ... seconds
	maxTime = 1200 !s          ! stop after maxTime seconds
	...
	dimOut = 1,0,1        ! 2D(x,z)-plot dimOut = 1,0,1, 3D with 1,1,1
        ...
        ! primary variables
	varOut = 1,1,1,0,1    ! 1 = output, 0 = no output for (rho,u,v,w,pi)
