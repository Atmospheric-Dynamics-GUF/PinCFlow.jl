...
&solverList
  ...
  dtMax_dim = 0.2!44.               ! max time step in s
...
&atmosphereList
  ...
  background = "realistic"      ! const-N    -> set N_BruntVaisala_dim
...
&outputList
  ...
  maxTime = 1800          ! stop after maxTime seconds
...
&testCaseList
  ...
  testCase = "hotBubble_heatedLayer"
