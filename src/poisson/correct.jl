      ...
      for i in 0:nx
        ...
        if k == 1 && zboundaries == SolidWallBoundaries()
          ...
          pgradx =
            ...
            (
              ...
              met13edger * (-dpuuedger + 4.0 * dpuedger - 3.0 * dpedger) * 0.5 /
              dz
            )
        elseif k == nz && zboundaries == SolidWallBoundaries()
          ...
          pgradx =
            ...
            (
              (dpip[i + 1, j, k] - dpip[i, j, k]) / dx +
              met13edger * (dpddedger - 4.0 * dpdedger + 3.0 * dpedger) * 0.5 /
              dz
            )
        else
          dpuedger = 0.5 * (dpip[i, j, k + 1] + dpip[i + 1, j, k + 1])
        ...
        if k == 1 && zboundaries == SolidWallBoundaries()
          ...
          pgrady =
            ...
            (
              ...
              met23edgef * (-dpuuedgef + 4.0 * dpuedgef - 3.0 * dpedgef) * 0.5 /
              dz
            )
        elseif k == nz && zboundaries == SolidWallBoundaries()
          ...
          pgrady =
            ...
            (
              (dpip[i, j + 1, k] - dpip[i, j, k]) / dy +
              met23edgef * (dpddedgef - 4.0 * dpdedgef + 3.0 * dpedgef) * 0.5 /
              dz
            )
        else
          dpuedgef = 0.5 * (dpip[i, j, k + 1] + dpip[i, j + 1, k + 1])
