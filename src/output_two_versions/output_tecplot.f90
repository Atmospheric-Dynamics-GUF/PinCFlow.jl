...
!    logical, parameter :: outComplex = .true.   -> now in input.f90 file
    ...
    if( .not. parameterStudy ) iParam_tmp = 0 ! modified by Junhong Wei (20161128)

!    write(unit=auxChar, fmt="(i2.2)") iParam              ! param study tag ! modified by Junhong Wei (20161128)
    write(unit=auxChar, fmt="(i2.2)") iParam_tmp              ! param study tag ! modified by Junhong Wei (20161128)
...
!    do i = 1,nDimOut ! modified by Junhong Wei (20161110)
    do i = 1, nDimOut + nOutVar - 1 ! modified by Junhong Wei (20161110)
       write(unit=40,fmt="(a)",advance="no") " Nodal, " ! modified by Junhong Wei (20161110)
    end do

! modified by Junhong Wei (20161128) *** starting line ***
...
!    write(unit=40,fmt="(a)",advance="yes") ")"
    ...
    write(unit=40,fmt="(a)",advance="no") " Nodal "   ! last entry without comma
    write(unit=40,fmt="(a)",advance="yes") ")"

! modified by Junhong Wei (20161128) *** finishing line ***
...
!                   write(unit=40,fmt="(4es17.6)") (y(-nby)-dy/2) * lRef   ! modified by Junhong Wei (20161110)
    ...
    if (dimOut(1)) then
!       i0 = 1; i1 = nx ! modified by Junhong Wei (20161125)
       i0 = 0; i1 = nx ! modified by Junhong Wei (20161125)
    else
       i0 = 1; i1 = 1 
    end if
    if (dimOut(2)) then
!          j0 = 1; j1 = ny ! modified by Junhong Wei (20161125)
       j0 = 0; j1 = ny ! modified by Junhong Wei (20161125)
    else
       j0 = 1; j1 = 1 
    end if
    if (dimOut(3)) then
!          k0 = 1; k1 = nz ! modified by Junhong Wei (20161125)
       k0 = 0; k1 = nz ! modified by Junhong Wei (20161125)
    else
       k0 = 1; k1 = 1  
    end if
