...
function set_meridional_boundaries!(
    ...
    if steady_state || single_column
        ...
        set_meridionalboundaries_of_reduced_field!(uw, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(vw, namelists, domain)
        # not necessary to set boundaries of e
        set_meridionalboundaries_of_reduced_field!(e, namelists, domain)
    else
        # transient mode
        set_meridionalboundaries_of_reduced_field!(uu, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(uv, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(uw, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(vv, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(vw, namelists, domain)
        # these are not necessary
        set_meridionalboundaries_of_reduced_field!(e, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(etx, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(ety, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(utheta, namelists, domain)
        set_meridionalboundaries_of_reduced_field!(vtheta, namelists, domain)
    end
    return
end
