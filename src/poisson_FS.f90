    ...
    if (opt == "expl") then
       if (timeScheme == "semiimplicit") then
          do k = 1,nz
             ...
             !fcscal_u = sqrt(PstratTilde(k)**2/rhoStratTilde(k))
             !fcscal_d = sqrt(PstratTilde(k-1)**2/rhoStratTilde(k-1))
          ...
          do k = 1,nz
             ...
             fcscal = 1.!sqrt(Pstrat(k)**2/rhoStrat(k))
             fcscal_u = 1.!sqrt(Pstrat(k+1)**2/rhoStrat(k+1))
             fcscal_d = 1.!sqrt(Pstrat(k-1)**2/rhoStrat(k-1))
