function set_zonal_halos_of_field!(
  ...
  MPI.Sendrecv!(send_f3_right, recv_f3_left, comm; dest = right, source = left)

  MPI.Sendrecv!(send_f3_left, recv_f3_right, comm; dest = left, source = right)
...
function set_zonal_halos_of_field!(
  ...
  MPI.Sendrecv!(send_f5_right, recv_f5_left, comm; dest = right, source = left)

  MPI.Sendrecv!(send_f5_left, recv_f5_right, comm; dest = left, source = right)
