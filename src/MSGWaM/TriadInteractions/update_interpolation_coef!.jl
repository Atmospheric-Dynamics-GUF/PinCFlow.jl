...
function update_interpolation_coef!(spec_tend::TriadTendencies, 
    ...
    if m[1] > 0
        update_interpolation_coef!(spec_tend, nk, Triad3DIso()) #calling the same function suitable for positive vertical wave numbers 
        return
    end
