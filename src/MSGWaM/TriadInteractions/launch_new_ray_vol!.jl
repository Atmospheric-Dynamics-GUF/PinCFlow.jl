...
function launch_new_ray_vol!(state::State, i::Integer, j::Integer, k::Integer, kpr::AbstractFloat, mr::AbstractFloat,
     dkpr::AbstractFloat, dmr::AbstractFloat, was::AbstractFloat)
     ...
     rays.k[ray_index, i, j, k] = sqrt(2) * kpr ##right now its launching the rays with positive wave numbers only.
