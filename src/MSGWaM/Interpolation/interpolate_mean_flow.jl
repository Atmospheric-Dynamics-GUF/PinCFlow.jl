...
# Returns
  ...
  - `::AbstractFloat`: Interpolated ``u`` at the location of interest.
...
# Returns
  ...
  - `::AbstractFloat`: Interpolated ``v`` at the location of interest.
...
# Returns
  ...
  - `::AbstractFloat`: Interpolated ``w`` at the location of interest.
