...
```math
\\begin{align*}
    \\left(\\frac{\\partial \\rho_\\mathrm{b} u_\\mathrm{b}}{\\partial t}\\right)_\\mathrm{w} & = - \\frac{\\rho_\\mathrm{b}}{\\overline{\\rho}} \\left[\\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{u} \\right\\rangle\\right)_{i + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{u} \\right\\rangle\\right)_{i - 1}}{2 \\Delta \\widehat{x}} + G^{13} \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{u} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{u} \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right.\\\\
    & \\qquad \\qquad + \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{v} \\right\\rangle\\right)_{j + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{v} \\right\\rangle\\right)_{j - 1}}{2 \\Delta \\widehat{y}} + G^{23} \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{v} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{v} \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\\\
    & \\qquad \\qquad + \\left.\\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{w} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{w} \\right\\rangle\\right)_{k - 1}}{2 J \\Delta \\widehat{z}}\\right] - \\rho_\\mathrm{b} \\frac{f}{\\overline{\\theta}} \\left\\langle \\tilde{\\theta} \\tilde{v} \\right\\rangle,\\\\
    \\left(\\frac{\\partial \\rho_\\mathrm{b} v_\\mathrm{b}}{\\partial t}\\right)_\\mathrm{w} & = - \\frac{\\rho_\\mathrm{b}}{\\overline{\\rho}} \\left[\\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{u} \\right\\rangle\\right)_{i + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{u} \\right\\rangle\\right)_{i - 1}}{2 \\Delta \\widehat{x}} + G^{13} \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{u} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{u} \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right.\\\\
    & \\qquad \\qquad + \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{v} \\right\\rangle\\right)_{j + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{v} \\right\\rangle\\right)_{j - 1}}{2 \\Delta \\widehat{y}} + G^{23} \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{v} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{v} \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\\\
    & \\qquad \\qquad + \\left.\\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{w} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{w} \\right\\rangle\\right)_{k - 1}}{2 J \\Delta \\widehat{z}}\\right] + \\rho_\\mathrm{b} \\frac{f}{\\overline{\\theta}} \\left\\langle \\tilde{\\theta} \\tilde{u} \\right\\rangle,\\\\
    ...
    \\left(\\frac{\\partial P_\\mathrm{b}}{\\partial t}\\right)_\\mathrm{w} & = - \\rho_\\mathrm{b} \\left[\\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{u} \\right\\rangle\\right)_{i + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{u} \\right\\rangle\\right)_{i - 1}}{2 \\Delta \\widehat{x}} + G^{13} \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{u} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{u} \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right.\\\\
    & \\qquad \\qquad + \\left.\\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{v} \\right\\rangle\\right)_{j + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{v} \\right\\rangle\\right)_{j - 1}}{2 \\Delta \\widehat{y}} + G^{23} \\frac{\\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{v} \\right\\rangle\\right)_{k + 1} - \\left(\\overline{\\rho} \\left\\langle \\tilde{\\theta} \\tilde{v} \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right],
\\end{align*}
```
