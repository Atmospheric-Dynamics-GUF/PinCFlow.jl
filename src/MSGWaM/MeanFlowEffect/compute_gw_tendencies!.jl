...
```math
\\begin{align*}
    \\left(\\frac{\\partial \\rho_\\mathrm{b} u_\\mathrm{b}}{\\partial t}\\right)_\\mathrm{w} & = - \\frac{\\rho_\\mathrm{b}}{\\bar{\\rho}} \\left[\\frac{\\left(\\bar{\\rho} \\left\\langle u' u' \\right\\rangle\\right)_{i + 1} - \\left(\\bar{\\rho} \\left\\langle u' u' \\right\\rangle\\right)_{i - 1}}{2 \\Delta \\widehat{x}} + G^{13} \\frac{\\left(\\bar{\\rho} \\left\\langle u' u' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle u' u' \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right.\\\\
    & \\qquad \\qquad + \\frac{\\left(\\bar{\\rho} \\left\\langle u' v' \\right\\rangle\\right)_{j + 1} - \\left(\\bar{\\rho} \\left\\langle u' v' \\right\\rangle\\right)_{j - 1}}{2 \\Delta \\widehat{y}} + G^{23} \\frac{\\left(\\bar{\\rho} \\left\\langle u' v' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle u' v' \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\\\
    & \\qquad \\qquad + \\left.\\frac{\\left(\\bar{\\rho} \\left\\langle u' w' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle u' w' \\right\\rangle\\right)_{k - 1}}{2 J \\Delta \\widehat{z}}\\right] - \\rho_\\mathrm{b} \\frac{f}{\\bar{\\theta}} \\left\\langle \\theta' v' \\right\\rangle,\\\\
    \\left(\\frac{\\partial \\rho_\\mathrm{b} v_\\mathrm{b}}{\\partial t}\\right)_\\mathrm{w} & = - \\frac{\\rho_\\mathrm{b}}{\\bar{\\rho}} \\left[\\frac{\\left(\\bar{\\rho} \\left\\langle v' u' \\right\\rangle\\right)_{i + 1} - \\left(\\bar{\\rho} \\left\\langle v' u' \\right\\rangle\\right)_{i - 1}}{2 \\Delta \\widehat{x}} + G^{13} \\frac{\\left(\\bar{\\rho} \\left\\langle v' u' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle v' u' \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right.\\\\
    & \\qquad \\qquad + \\frac{\\left(\\bar{\\rho} \\left\\langle v' v' \\right\\rangle\\right)_{j + 1} - \\left(\\bar{\\rho} \\left\\langle v' v' \\right\\rangle\\right)_{j - 1}}{2 \\Delta \\widehat{y}} + G^{23} \\frac{\\left(\\bar{\\rho} \\left\\langle v' v' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle v' v' \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\\\
    & \\qquad \\qquad + \\left.\\frac{\\left(\\bar{\\rho} \\left\\langle v' w' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle v' w' \\right\\rangle\\right)_{k - 1}}{2 J \\Delta \\widehat{z}}\\right] + \\rho_\\mathrm{b} \\frac{f}{\\bar{\\theta}} \\left\\langle \\theta' u' \\right\\rangle,\\\\
    ...
    \\left(\\frac{\\partial P_\\mathrm{b}}{\\partial t}\\right)_\\mathrm{w} & = - \\rho_\\mathrm{b} \\left[\\frac{\\left(\\bar{\\rho} \\left\\langle \\theta' u' \\right\\rangle\\right)_{i + 1} - \\left(\\bar{\\rho} \\left\\langle \\theta' u' \\right\\rangle\\right)_{i - 1}}{2 \\Delta \\widehat{x}} + G^{13} \\frac{\\left(\\bar{\\rho} \\left\\langle \\theta' u' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle \\theta' u' \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right.\\\\
    & \\qquad \\qquad + \\left.\\frac{\\left(\\bar{\\rho} \\left\\langle \\theta' v' \\right\\rangle\\right)_{j + 1} - \\left(\\bar{\\rho} \\left\\langle \\theta' v' \\right\\rangle\\right)_{j - 1}}{2 \\Delta \\widehat{y}} + G^{23} \\frac{\\left(\\bar{\\rho} \\left\\langle \\theta' v' \\right\\rangle\\right)_{k + 1} - \\left(\\bar{\\rho} \\left\\langle \\theta' v' \\right\\rangle\\right)_{k - 1}}{2 \\Delta \\widehat{z}}\\right],
\\end{align*}
```
