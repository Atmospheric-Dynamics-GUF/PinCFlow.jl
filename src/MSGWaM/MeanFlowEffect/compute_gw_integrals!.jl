...
```math
\\begin{align*}
    \\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{u} \\right\\rangle & = \\frac{\\overline{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(u_\\mathrm{w} u_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{v} \\right\\rangle & = \\frac{\\overline{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(u_\\mathrm{w} v_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{w} \\right\\rangle & = \\frac{\\overline{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(u_\\mathrm{w} w_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{v} \\right\\rangle & = \\frac{\\overline{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(v_\\mathrm{w} v_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{w} \\right\\rangle & = \\frac{\\overline{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(v_\\mathrm{w} w_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\left\\langle \\tilde{\\theta} \\tilde{u} \\right\\rangle & = \\frac{1}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(\\theta_\\mathrm{w} u_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\left\\langle \\tilde{\\theta} \\tilde{v} \\right\\rangle & = \\frac{1}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(\\theta_\\mathrm{w} v_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
...
```math
\\begin{align*}
    \\frac{\\overline{\\rho}}{2} \\Re \\left(u_{\\mathrm{w}, r} u_{\\mathrm{w}, r}^*\\right) & = \\left(k_r \\widehat{c}_{\\mathrm{g} x, r} - \\mathrm{sgn} \\left(f^2\\right) \\frac{k_r \\widehat{c}_{\\mathrm{g} x, r} + l_r \\widehat{c}_{\\mathrm{g} y, r}}{1 - \\left(\\widehat{\\omega}_r / f\\right)^2}\\right) \\mathcal{A}_r,\\\\
    \\frac{\\overline{\\rho}}{2}  \\Re \\left(u_{\\mathrm{w}, r} v_{\\mathrm{w}, r}^*\\right) & = l_r \\widehat{c}_{\\mathrm{g} x, r} \\mathcal{A}_r,\\\\
    \\frac{\\overline{\\rho}}{2} \\Re \\left(u_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = \\frac{k_r \\widehat{c}_{\\mathrm{g} z, r}}{1 - \\left(f / \\widehat{\\omega}_r\\right)^2} \\mathcal{A}_r,\\\\
    \\frac{\\overline{\\rho}}{2} \\Re \\left(v_{\\mathrm{w}, r} v_{\\mathrm{w}, r}^*\\right) & = \\left(l_r \\widehat{c}_{\\mathrm{g} y, r} - \\mathrm{sgn} \\left(f^2\\right) \\frac{k_r \\widehat{c}_{\\mathrm{g} x, r} + l_r \\widehat{c}_{\\mathrm{g} y, r}}{1 - \\left(\\widehat{\\omega}_r / f\\right)^2}\\right) \\mathcal{A}_r,\\\\
    \\frac{\\overline{\\rho}}{2} \\Re \\left(v_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = \\frac{l_r \\widehat{c}_{\\mathrm{g} z, r}}{1 - \\left(f / \\widehat{\\omega}_r\\right)^2} \\mathcal{A}_r,\\\\
    \\frac{1}{2} \\Re \\left(\\theta_{\\mathrm{w}, r} u_{\\mathrm{w}, r}^*\\right) & = \\frac{f}{g} \\frac{\\overline{\\theta}}{\\overline{\\rho}} \\frac{l_r m_r N_r^2}{\\widehat{\\omega}_r \\left|\\boldsymbol{k}_r\\right|^2} \\mathcal{A}_r,\\\\
    \\frac{1}{2} \\Re \\left(\\theta_{\\mathrm{w}, r} v_{\\mathrm{w}, r}^*\\right) & = - \\frac{f}{g} \\frac{\\overline{\\theta}}{\\overline{\\rho}} \\frac{k_r m_r N_r^2}{\\widehat{\\omega}_r \\left|\\boldsymbol{k}_r\\right|^2} \\mathcal{A}_r,
\\end{align*}
```
...
This method computes ``\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{w} \\right\\rangle``, ``\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{w} \\right\\rangle``, ``\\left\\langle \\tilde{\\theta} \\tilde{u} \\right\\rangle``, ``\\left\\langle \\tilde{\\theta} \\tilde{v} \\right\\rangle`` and ``\\mathcal{E}`` (see above for details).
...
This method computes the sums ``\\overline{\\rho} \\left\\langle \\tilde{u} \\tilde{w} \\right\\rangle`` and ``\\overline{\\rho} \\left\\langle \\tilde{v} \\tilde{w} \\right\\rangle`` (see above for details). In contrast to the multi-column and single-column modes, the steady-state mode uses the pseudo-momentum approximation

```math
\\begin{align*}
    \\frac{\\overline{\\rho}}{2} \\Re \\left(u_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = k_r \\widehat{c}_{\\mathrm{g} z, r} \\mathcal{A}_r,\\\\
    \\frac{\\overline{\\rho}}{2} \\Re \\left(v_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = l_r \\widehat{c}_{\\mathrm{g} z, r} \\mathcal{A}_r.
\\end{align*}
```
