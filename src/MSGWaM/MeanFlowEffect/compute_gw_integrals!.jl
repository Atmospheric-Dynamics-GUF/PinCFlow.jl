...
```math
\\begin{align*}
    \\bar{\\rho} \\left\\langle \\tilde{u} \\tilde{u} \\right\\rangle & = \\frac{\\bar{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(u_\\mathrm{w} u_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\bar{\\rho} \\left\\langle \\tilde{u} \\tilde{v} \\right\\rangle & = \\frac{\\bar{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(u_\\mathrm{w} v_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\bar{\\rho} \\left\\langle \\tilde{u} \\tilde{w} \\right\\rangle & = \\frac{\\bar{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(u_\\mathrm{w} w_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\bar{\\rho} \\left\\langle \\tilde{v} \\tilde{v} \\right\\rangle & = \\frac{\\bar{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(v_\\mathrm{w} v_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
    \\bar{\\rho} \\left\\langle \\tilde{v} \\tilde{w} \\right\\rangle & = \\frac{\\bar{\\rho}}{2} \\sum_{r, \\lambda, \\mu, \\nu} \\left[F \\Re \\left(v_\\mathrm{w} w_\\mathrm{w}^*\\right)\\right]_{r, i + \\lambda, j + \\mu, k + \\nu},\\\\
...
```math
\\begin{align*}
    \\frac{\\bar{\\rho}}{2} \\Re \\left(u_{\\mathrm{w}, r} u_{\\mathrm{w}, r}^*\\right) & = \\left(k_r \\hat{c}_{\\mathrm{g} x, r} - \\mathrm{sgn} \\left(f^2\\right) \\frac{k_r \\hat{c}_{\\mathrm{g} x, r} + l_r \\hat{c}_{\\mathrm{g} y, r}}{1 - \\left(\\hat{\\omega}_r / f\\right)^2}\\right) \\mathcal{A}_r,\\\\
    \\frac{\\bar{\\rho}}{2}  \\Re \\left(u_{\\mathrm{w}, r} v_{\\mathrm{w}, r}^*\\right) & = l_r \\hat{c}_{\\mathrm{g} x, r} \\mathcal{A}_r,\\\\
    \\frac{\\bar{\\rho}}{2} \\Re \\left(u_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = \\frac{k_r \\hat{c}_{\\mathrm{g} z, r}}{1 - \\left(f / \\hat{\\omega}_r\\right)^2} \\mathcal{A}_r,\\\\
    \\frac{\\bar{\\rho}}{2} \\Re \\left(v_{\\mathrm{w}, r} v_{\\mathrm{w}, r}^*\\right) & = \\left(l_r \\hat{c}_{\\mathrm{g} y, r} - \\mathrm{sgn} \\left(f^2\\right) \\frac{k_r \\hat{c}_{\\mathrm{g} x, r} + l_r \\hat{c}_{\\mathrm{g} y, r}}{1 - \\left(\\hat{\\omega}_r / f\\right)^2}\\right) \\mathcal{A}_r,\\\\
    \\frac{\\bar{\\rho}}{2} \\Re \\left(v_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = \\frac{l_r \\hat{c}_{\\mathrm{g} z, r}}{1 - \\left(f / \\hat{\\omega}_r\\right)^2} \\mathcal{A}_r,\\\\
    \\frac{1}{2} \\Re \\left(\\theta_{\\mathrm{w}, r} u_{\\mathrm{w}, r}^*\\right) & = \\frac{f}{g} \\frac{\\bar{\\theta}}{\\bar{\\rho}} \\frac{l_r m_r N_r^2}{\\hat{\\omega}_r \\left|\\boldsymbol{k}_r\\right|^2} \\mathcal{A}_r,\\\\
    \\frac{1}{2} \\Re \\left(\\theta_{\\mathrm{w}, r} v_{\\mathrm{w}, r}^*\\right) & = - \\frac{f}{g} \\frac{\\bar{\\theta}}{\\bar{\\rho}} \\frac{k_r m_r N_r^2}{\\hat{\\omega}_r \\left|\\boldsymbol{k}_r\\right|^2} \\mathcal{A}_r,
\\end{align*}
```
...
In the case of turbulence parameterization, the gravity-wave induced shear ``\\mathcal{S}_{gw}`` is calculated (see [`PinCFlow.MSGWaM.MeanFlowEffect.compute_gw_shear!`](@ref) for more details).
...
This method computes the sums ``\\bar{\\rho} \\left\\langle \\tilde{u} \\tilde{w} \\right\\rangle``, ``\\bar{\\rho} \\left\\langle \\tilde{v} \\tilde{w} \\right\\rangle``, ``\\bar{\\rho}\\left\\langle\\tilde{u}\\tilde{\\chi}\\right\\rangle``, ``\\bar{\\rho}\\left\\langle\\tilde{v}\\tilde{\\chi}\\right\\rangle``, ``\\bar{\\rho}\\left\\langle\\tilde{w}\\tilde{\\chi}\\right\\rangle`` and ``\\mathcal{S}_{gw}`` (see above for details). In contrast to the multi-column and single-column modes, the steady-state mode uses the pseudo-momentum approximation

```math
\\begin{align*}
    \\frac{\\bar{\\rho}}{2} \\Re \\left(u_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = k_r \\hat{c}_{\\mathrm{g} z, r} \\mathcal{A}_r,\\\\
    \\frac{\\bar{\\rho}}{2} \\Re \\left(v_{\\mathrm{w}, r} w_{\\mathrm{w}, r}^*\\right) & = l_r \\hat{c}_{\\mathrm{g} z, r} \\mathcal{A}_r.
\\end{align*}
```
