function calc_gw_tendencies!(state)
  ...
  for kz in k0:k1, jy in j0:j1, ix in i0:i1
    ...
    integrals.dudt[ix, jy, kz] =
      ...
      (integrals.uw[ix, jy, kz + 1] - integrals.uw[ix, jy, kz - 1]) / (2.0 * dz)

    if sizex > 1
      integrals.dudt[ix, jy, kz] =
        integrals.dudt[ix, jy, kz] -
        rhotot / rhostrattfc[ix, jy, kz] * (
          (integrals.uu[ix + 1, jy, kz] - integrals.uu[ix - 1, jy, kz]) /
          (2.0 * dx) +
          met[ix, jy, kz, 1, 3] *
          (integrals.uu[ix, jy, kz + 1] - integrals.uu[ix, jy, kz - 1]) /
          (2.0 * dz)
        )
    end
    ...
    if sizey > 1
      integrals.dudt[ix, jy, kz] =
        integrals.dudt[ix, jy, kz] -
        rhotot / rhostrattfc[ix, jy, kz] * (
          (integrals.uv[ix, jy + 1, kz] - integrals.uv[ix, jy - 1, kz]) /
          (2.0 * dy) +
          met[ix, jy, kz, 2, 3] *
          (integrals.uv[ix, jy, kz + 1] - integrals.uv[ix, jy, kz - 1]) /
          (2.0 * dz)
        )
    end
    ...
    integrals.dvdt[ix, jy, kz] =
      -rhotot / rhostrattfc[ix, jy, kz] / jac[ix, jy, kz] *
      (integrals.vw[ix, jy, kz + 1] - integrals.vw[ix, jy, kz - 1]) / (2.0 * dz)

    if sizex > 1
      integrals.dvdt[ix, jy, kz] =
        integrals.dvdt[ix, jy, kz] -
        rhotot / rhostrattfc[ix, jy, kz] * (
          (integrals.uv[ix + 1, jy, kz] - integrals.uv[ix - 1, jy, kz]) /
          (2.0 * dx) +
          met[ix, jy, kz, 1, 3] *
          (integrals.uv[ix, jy, kz + 1] - integrals.uv[ix, jy, kz - 1]) /
          (2.0 * dz)
    ...
    if sizey > 1
      integrals.dvdt[ix, jy, kz] =
        integrals.dvdt[ix, jy, kz] -
        rhotot / rhostrattfc[ix, jy, kz] * (
          (integrals.vv[ix, jy + 1, kz] - integrals.vv[ix, jy - 1, kz]) /
          (2.0 * dy) +
          met[ix, jy, kz, 2, 3] *
          (integrals.vv[ix, jy, kz + 1] - integrals.vv[ix, jy, kz - 1]) /
          (2.0 * dz)
        )
    end
