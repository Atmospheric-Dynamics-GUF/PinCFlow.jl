function set_meridional_halo_ray_volumes!(state::State)
  ...
  @views rays.area_xk[
    ...
    rays.dxray[1:nray_max_forw, (i0 - 1):(i1 + 1), j0 - 1, (k0 - 1):(k1 + 1)] *
    rays.dkray[1:nray_max_forw, (i0 - 1):(i1 + 1), j0 - 1, (k0 - 1):(k1 + 1)]
  @views rays.area_yl[
    1:nray_max_forw,
    (i0 - 1):(i1 + 1),
    j0 - 1,
    ...
    rays.dyray[1:nray_max_forw, (i0 - 1):(i1 + 1), j0 - 1, (k0 - 1):(k1 + 1)] *
    rays.dlray[1:nray_max_forw, (i0 - 1):(i1 + 1), j0 - 1, (k0 - 1):(k1 + 1)]
  @views rays.area_zm[
    1:nray_max_forw,
    (i0 - 1):(i1 + 1),
    j0 - 1,
    ...
    rays.dzray[1:nray_max_forw, (i0 - 1):(i1 + 1), j0 - 1, (k0 - 1):(k1 + 1)] *
    rays.dmray[1:nray_max_forw, (i0 - 1):(i1 + 1), j0 - 1, (k0 - 1):(k1 + 1)]
  ...
  @views rays.area_xk[
    ...
    rays.dxray[1:nray_max_back, (i0 - 1):(i1 + 1), j1 + 1, (k0 - 1):(k1 + 1)] *
    rays.dkray[1:nray_max_back, (i0 - 1):(i1 + 1), j1 + 1, (k0 - 1):(k1 + 1)]
  @views rays.area_yl[
    1:nray_max_back,
    (i0 - 1):(i1 + 1),
    j1 + 1,
    ...
    rays.dyray[1:nray_max_back, (i0 - 1):(i1 + 1), j1 + 1, (k0 - 1):(k1 + 1)] *
    rays.dlray[1:nray_max_back, (i0 - 1):(i1 + 1), j1 + 1, (k0 - 1):(k1 + 1)]
  @views rays.area_zm[
    1:nray_max_back,
    (i0 - 1):(i1 + 1),
    j1 + 1,
    ...
    rays.dzray[1:nray_max_back, (i0 - 1):(i1 + 1), j1 + 1, (k0 - 1):(k1 + 1)] *
    rays.dmray[1:nray_max_back, (i0 - 1):(i1 + 1), j1 + 1, (k0 - 1):(k1 + 1)]
