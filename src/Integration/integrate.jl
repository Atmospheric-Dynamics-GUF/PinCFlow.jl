...
function integrate(namelists::Namelists, shear::AbstractArray)
    ...
    for itime in 1:maxiterations
        ...
        p_new.u .=  p_new.u .+ shear_predictands #modification in predictands due to shear
   
        compute_fluxes!(state, p_new, Theta())
        ...
        explicit_integration!(state, p0, shear_predictands, 0.5 * dt, time, LHS())
        ...
        explicit_integration!(state, p0, shear_predictands, dt, time, LHS())
