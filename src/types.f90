module type_module
  ...
  integer :: nxNSCX, nyNSCY, nzNSCZ
  !integer, parameter :: nbxSC = 1, nbySC = 1, nbzSC = 1
  !integer, parameter :: nbxSC = 2, nbySC =2, nbzSC = 2
  integer, parameter :: nbxSC = 4, nbySC = 4, nbzSC = 4
  real :: dxsc, dysc, dzsc
  ...
  real, parameter :: timeIceIntegration = 0. !1.e4 ! time to start ice integration [s]
  ...
  real, dimension(:, :, :), allocatable :: z2TFC
  integer :: SizeX2, SizeY2, SizeZ2

  real :: zMax_issr, zMin_issr

  namelist / iceList / inN, inQ, inQv, nVarIce, dt_ice, no_ice_source, &
      &parameterized_nucleation, average_cell, average_cell_3, &
      &compute_cloudcover, NSCX, NSCY, NSCZ, gauss_smoothing, &
      &reconstruct_gw_field, compare_raytracer
