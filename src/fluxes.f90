...
!       end select
       ...
       ! FS June2020: 
       ! muscl1 -> old reconstruction without P
       ! muscl2 -> new reconstruction rho/P, v, does not work properly (?)
...
!!$                     & + (wSurfU - wSurfD) / dz
  ...
  subroutine massFlux_GB (vara,var,flux,fluxmode)
    !---------------------------------------------------------------------
