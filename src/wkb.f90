...
contains
             ...
             do iRay = 1,nRay(ixrv,jyrv,kzrv)
                ...
                if (sizeX > 1) then
                   if (xBoundary /= "periodic") then
                      print*,'ERROR in calc_meanflow_effect: &
                            & boundary conditions in x must be periodic'
                      stop
                   end if
                   ...
                   if (ixrv == 0 .and. is + nbx == 1) then
                      if (xr > lx(1) - dx .and. xr < lx(1)) then
                        ...
                        elseif (xr > lx(0) - dx &
                         ...
                         print*,'ERROR in calc_meanflow_effect:'
                         print*,'xr =', xr
                         print*,'but r.v. is in ghost cell to the &
                               & left of the leftmost cpu so that &
                               & one should have either'
                         print*,lx(1) - dx,&
                              & '= lx(1) - dx < xr < lx(1) =',&
                              & lx(1),' or'
                         print*,lx(0) - dx, &
                             & '= lx(0) - dx < xr < lx(0) =',lx(0)
                         stop
                      end if
                   end if
                   ...
                   if (ixrv == nx+1 .and. is + nbx + nx == sizeX) then
                      if (xr > lx(0) .and. xr < lx(0) + dx) then
                        ...
                        elseif (xr > lx(1) &
                         ...
                         print*,'xr =', xr
                         print*,'but r.v. is in ghost cell to the &
                               & right of the rightmost cpu so that &
                               & one should have either'
                         print*,lx(0),'= lx(0) < xr < lx(0) + dx =',&
                              & lx(0) + dx,' or'
                         print*,lx(1),'= lx(1) < xr < lx(1) + dx =',&
                              & lx(1) + dx
                         stop
                      end if
                   end if
                ...
                if (sizeY > 1) then
                   if (yBoundary /= "periodic") then
                      print*,'ERROR in calc_meanflow_effect: &
                            & boundary conditions in y must be periodic'
                      stop
                   end if
                   ...
                   if (jyrv == 0 .and. js + nby == 1) then
                      if (yr > ly(1) - dy .and. yr < ly(1)) then
                        ...
                        elseif (yr > ly(0) - dy &
                         ...
                         print*,'ERROR in calc_meanflow_effect:'
                         print*,'yr =', yr
                         print*,'but r.v. is in ghost cell in front&
                               & of the first cpu in y dir. so that &
                               & one should have either'
                         print*,ly(1) - dy,&
                              & '= ly(1) - dy < yr < ly(1) =',&
                              & ly(1),' or'
                         print*,ly(0) - dy, &
                             & '= ly(0) - dy < yr < ly(0) =',ly(0)
                         stop
                      end if
                   end if
                   ...
                   if (jyrv == ny+1 .and. js + nby + ny == sizeY) then
                      if (yr > ly(0) .and. yr < ly(0) + dy) then
                        ...
                        elseif (yr > ly(1) &
                         ...
                         print*,'ERROR in calc_meanflow_effect:'
                         print*,'yr =', yr
                         print*,'but r.v. is in ghost cell behind&
                               & the last cpu in y dir. so that &
                               & one should have either'
                         print*,ly(0),'= ly(0) < yr < ly(0) + dy =',&
                              & ly(0) + dy,' or'
                         print*,ly(1),'= ly(1) < yr < ly(1) + dy =',&
                              & ly(1) + dy
                         stop
                      end if
                   end if
                ...
                if (zr < lz(0) - dz) then
                   print*,'ERROR IN calc_meanflow_effect: RAY VOLUME', &
                           iRay,'in cell',ixrv,jyrv,kzrv,'TOO LOW'
                   stop
                end if
                ...
                if (sizeX > 1) then
                   ...
                   if (ixmin > nx+1) then
                      ...
                      print*,'lx(1) =',lx(1)
                      print*,'ix0 =',ix0
                      print*,'floor((xr - dxr*0.5 - lx(0)) / dx) + 1 =',&
                ...
                do kz = kzmin, kzmax
                   dzi = (min((zr+dzr*0.5),lz(0)+kz*dz)&
                        - max((zr-dzr*0.5),lz(0)+(kz-1)*dz))
                      ...
                      do ix = ixmin, ixmax
                         ...
                         if (sizeX > 1) then
                            if (f_cor_nd /= 0.0) then
                               ...
                               var_uu(ix,jy,kz) &
                               = var_uu(ix,jy,kz) + wadr * wnrk * cgirx
                            end if
                         end if

                         if (sizeX > 1 .or. sizeY > 1) then
                            var_uv(ix,jy,kz) &
                            = var_uv(ix,jy,kz) + wadr * cgirx * wnrl
                         end if
                         ...
                         if (sizeY > 1) then
                            if (f_cor_nd /= 0.0) then
                               ...
                               var_vv(ix,jy,kz) &
                               = var_vv(ix,jy,kz) + wadr * wnrl * cgiry
                            end if
                         end if
       ...
       do jy = 1,ny
          do ix = 1,nx
             ...
             if (sizeX > 1) then
                ...
                = var_drudt(ix,jy,kz) &
                  - rhotot/rhoStrat(kz) &
                    * (var_uu(ix+1,jy,kz) - var_uu(ix-1,jy,kz))/(2.0*dx)
             end if
             ...
             if (sizeY > 1) then
                ...
                = var_drudt(ix,jy,kz) &
                  - rhotot/rhoStrat(kz) &
                    * (var_uv(ix,jy+1,kz) - var_uv(ix,jy-1,kz))/(2.0*dy)
             end if

             var_drudt(ix,jy,kz) &
             = var_drudt(ix,jy,kz) + rhotot * var_ETx(ix,jy,kz)
             ...
             var_drvdt(ix,jy,kz) &
             = -rhotot/rhoStrat(kz) &
                * (var_vw(ix,jy,kz+1) - var_vw(ix,jy,kz-1))/(2.0*dz)

             if (sizeX > 1) then
                var_drvdt(ix,jy,kz) &
                = var_drvdt(ix,jy,kz) &
                  - rhotot/rhoStrat(kz) &
                    * (var_uv(ix+1,jy,kz) - var_uv(ix-1,jy,kz))/(2.0*dx)
             end if
             ...
             if (sizeY > 1) then
                ...
                = var_drvdt(ix,jy,kz) &
                  - rhotot/rhoStrat(kz) &
                    * (var_vv(ix,jy+1,kz) - var_vv(ix,jy-1,kz))/(2.0*dy)
             end if

             var_drvdt(ix,jy,kz) &
             = var_drvdt(ix,jy,kz) + rhotot * var_ETy(ix,jy,kz)
          end do
       end do
    end do
          ...
          do jy = 1,ny
             do ix = 1,nx
                ...
                if (sizeX > 1) then
                   var_drtdt(ix,jy,kz) &
                   = rhotot &
                     * (var_ut(ix+1,jy,kz) - var_ut(ix-1,jy,kz))/(2.0*dx)
                end if
                ...
                if (sizeY > 1) then
                   ...
                   = var_drtdt(ix,jy,kz) &
                     + rhotot &
                       * (var_vt(ix,jy+1,kz) - var_vt(ix,jy-1,kz))/(2.0*dy)
                end if
             end do
          end do
       end do
  ...
  subroutine setup_wkb(ray, ray_var3D, var)
    ...
    ! MPI variables
    integer :: oldtypes(14), blockcounts(13), ioffset
    integer(KIND=MPI_ADDRESS_KIND) :: offsets(13)

    real, allocatable :: omi_notop(:), &
                       & omi_sfc(:,:), &
    ...
    allocate( ray(nray_wrk,0:nx+1,0:ny+1,-1:nz+2), &
              stat=allocstat)
    ...
    ! create mpi_ray_type
    call mpi_get_address(ray(1,0,0,-1)%x,       offsets(1),  ierror)
    call mpi_get_address(ray(1,0,0,-1)%y,       offsets(2),  ierror)
    call mpi_get_address(ray(1,0,0,-1)%z,       offsets(3),  ierror)
    call mpi_get_address(ray(1,0,0,-1)%k,       offsets(4),  ierror)
    call mpi_get_address(ray(1,0,0,-1)%l,       offsets(5),  ierror)
    call mpi_get_address(ray(1,0,0,-1)%m,       offsets(6),  ierror)
    call mpi_get_address(ray(1,0,0,-1)%dxray,   offsets(7),  ierror)
    call mpi_get_address(ray(1,0,0,-1)%dyray,   offsets(8), ierror)
    call mpi_get_address(ray(1,0,0,-1)%dzray,   offsets(9), ierror)
    call mpi_get_address(ray(1,0,0,-1)%dkray,   offsets(10), ierror)
    call mpi_get_address(ray(1,0,0,-1)%dlray,   offsets(11), ierror)
    call mpi_get_address(ray(1,0,0,-1)%dmray,   offsets(12), ierror)
    call mpi_get_address(ray(1,0,0,-1)%dens,    offsets(13),  ierror)
    do ioffset = 2, size(offsets)
      offsets(ioffset) = offsets(ioffset) - offsets(1)
    end do
    offsets(1) = 0
    blockcounts(:) = 1
    oldtypes(:) = mpi_double_precision
    call mpi_type_create_struct(13, blockcounts, offsets, &
         oldtypes, mpi_raytype, ierror)
    call mpi_type_commit(mpi_raytype, ierror)
    ...
    allocate( dxRay(3,nray_wrk,0:nx+1,0:ny+1,-1:nz+2), &
              stat=allocstat)
    if(allocstat /= 0) stop "setup_wkb: could not allocate dxRay"

    ! wave vector increment
    allocate( dkRay(3,nray_wrk,0:nx+1,0:ny+1,-1:nz+2), &
              stat=allocstat)
    ...
    if (case_wkb == 3) then
       ...
       do jy=1, ny
          do ix = 1, nx
             ...
             if (      (sigwpx == 0.0 .or. abs(x(ix+ix0) - xr0) < sigwpx) &
                 .and. (sigwpy == 0.0 .or. abs(y(jy+jy0) - yr0) < sigwpy)) then
       ...
       do kz = 1, sizeZ
          ...
          omi_notop(kz) &
          = branchr &
            *sqrt((  NN_nd * wnrh_init**2 &
                   + f_cor_nd**2*wnrm_init**2) &
          ...
          do jy = 1, ny
             do ix = 1, nx
                fld_amp(ix,jy,kz) &
                = (amp_wkb/wnrm_init)**2 * (wnrh_init**2 + wnrm_init**2) &
                  /(2.0 * wnrh_init**2) * omi_notop(kz) * rhoStrat(kz)

                if (case_wkb == 1) then
                   fld_amp(ix,jy,kz) &
                   = fld_amp(ix,jy,kz) * exp(-((z(kz)-zr0)/sigwpz)**2)

                   if (sigwpx_dim > 0.0) then
                      fld_amp(ix,jy,kz) &
                      = fld_amp(ix,jy,kz) * exp(-((x(ix+ix0)-xr0)/sigwpx)**2)
                   end if

                   if (sigwpy_dim > 0.0) then
                      fld_amp(ix,jy,kz) &
                      = fld_amp(ix,jy,kz) * exp(-((y(jy+jy0)-yr0)/sigwpy)**2)
                   end if
                  elseif (case_wkb == 2) then
                   if (abs(z(kz)-zr0) < sigwpz) then
                      fld_amp(ix,jy,kz) &
                      = fld_amp(ix,jy,kz) &
                        * 0.5 * (1.0 + cos(pi*(z(kz)-zr0)/sigwpz))
                      ...
                      do jl = 1, nrl_init
                         ...
                         do kz2 = kz2min, nrzl
                            do km = 1, nrm_init
                               ...
                               ray(iRay,ix,jy,kz)%x &
                               = (x(ix+ix0) - 0.5*dx + (ix2-0.5)*dx/nrxl)

                               ray(iRay,ix,jy,kz)%y &
                               = (y(jy+jy0) - 0.5*dy + (jy2-0.5)*dy/nryl)

                               ray(iRay,ix,jy,kz)%z &
                               = (z(kz) - 0.5*dz + (kz2-0.5)*dz/nrzl)
                               ...
                               if (zr < lz(0) - dz) then
                                  print*,'ERROR IN setup_wkb: RAY VOLUME',&
                                          & iRay,'at',ix,jy,kz,'TOO LOW'
                                  stop
                               end if
    ...
    call mpi_reduce(nrsuml, nr_sum, 1, mpi_integer,&
    ...
    if (master) then
       ...
       if( rayTracer ) then
          ...
          write(*,fmt="(a25,f7.1)") "nb rays / grid cell  = ",  &
                  & real(nr_sum)/(sizeX*sizeY*(sizeZ+1))
          write(*,fmt="(a31,i7)") "max allowed nb of rays / cell = ", &
                  & nray_max
         else
  ...
  subroutine split_rayvol(ray)
    ...
    call mpi_reduce(nrvloc, nrvtt0, 1, &
                  & mpi_integer, mpi_sum, root, comm, ierror)
    call mpi_bcast(nrvtt0, 1, &
          ...
          do ix = 1, nx
                ...
                do iRay = 1, nRay(ix,jy,kz)
                   ...
                   if(dxr > dx .and. zr - 0.5*dzr > lz(0)) then
                      ...
                      if (nrlc > nray_wrk) then
                         print*,'r.v. getting too many by splitting in x &
                                 & direction'
                         stop
                      end if
             ...
             if (sizeY > 1) then
                do iRay = 1, nRay(ix,jy,kz)
                   ...
                   if(dyr > dy .and. zr - 0.5*dzr > lz(0)) then
                      ...
                      if (nrlc > nray_wrk) then
                         print*,'r.v. getting too many by splitting in y &
                                 & direction'
                         stop
                      end if
             ...
             do iRay = 1, nRay(ix,jy,kz)
                ...
                if(dzr > dz .and. zr - 0.5*dzr > lz(0)) then
                   ...
                   if (nrlc > nray_wrk) then
                      print*,'r.v. getting too many by splitting in z &
                              & direction'
                      stop
                   end if
    ...
    call mpi_reduce(nrvloc, nrvtt1, 1, &
                  & mpi_integer, mpi_sum, root, comm, ierror)
    call mpi_bcast(nrvtt1, 1, &
                 & mpi_integer, root, comm, ierror)
  ...
  subroutine shift_rayvol(ray)
    ...
    integer, dimension(:,:,:), allocatable :: nshl, nshr, nshb, nshf, &
                                              & nshd, nshu
          ...
          do jy = 0, ny+1
             do ix = 1, nx
                   ...
                   do ish = 1, nshr(ix-1,jy,kz)
                      ...
                      if (nsh == 0) then
                        ...
                        elseif (iRay > irsh(nsh)) then
                         ...
                         !testb
                         if (nsh < 2) then
                            print*,'ERROR: nsh < 2 in x-shifting where &
                ...
                if (nsh > 0) then
                   ...
                   if (nrlc &
                       & /= nRay(ix,jy,kz) &
                       &    - nshl(ix+1,jy,kz) - nshr(ix-1,jy,kz)) then
                       print*,'at ix,jy,kz =',ix,jy,kz,&
                               & 'nrlc /= nRay(ix,jy,kz) &
          ...
          do jy = 1, ny
             do ix = 0, nx+1
                   ...
                   do ish = 1, nshf(ix,jy-1,kz)
                      ...
                      if (nsh == 0) then
                        ...
                        elseif (iRay > irsh(nsh)) then
                         ...
                         !testb
                         if (nsh < 2) then
                            print*,'ERROR: nsh < 2 in y-shifting where &
                                    & this must not be the case'
                            stop
                         end if
                         !teste
                ...
                if (nsh > 0) then
                   ...
                   if (nrlc &
                       & /= nRay(ix,jy,kz) &
                       &    - nshb(ix,jy+1,kz) - nshf(ix,jy-1,kz)) then
                       print*,'at ix,jy,kz =',ix,jy,kz,&
                               & 'nrlc /= nRay(ix,jy,kz) &
          ...
          do jy = 0, ny+1
             do ix = 0, nx+1
                   ...
                   do ish = 1, nshu(ix,jy,kz-1)
                      ...
                      if (nsh == 0) then
                        ...
                        elseif (iRay > irsh(nsh)) then
                         ...
                         !testb
                         if (nsh < 2) then
                            print*,'ERROR: nsh < 2 in z-shifting where &
                                    & this must not be the case'
                            stop
                         end if
                         !teste
                ...
                if(nsh > 0) then
                   ...
                   if (nrlc &
                       & /= nRay(ix,jy,kz) &
                       &    - nshd(ix,jy,kz+1) - nshu(ix,jy,kz-1)) then
                       print*,'at ix,jy,kz =',ix,jy,kz,&
                               & 'nrlc /= nRay(ix,jy,kz) &
  ...
  subroutine merge_rayvol(ray)
    ...
    real :: wnrk_min_p, wnrk_max_p, wnrl_min_p, wnrl_max_p, &
            wnrm_min_p, wnrm_max_p
    real :: wnrk_min_n, wnrk_max_n, wnrl_min_n, wnrl_max_n, &
            wnrm_min_n, wnrm_max_n
    ...
    real, dimension(:), allocatable :: xrmnmg, xrmxmg, &
                                       & yrmnmg, yrmxmg, &
                                       & zrmnmg, zrmxmg

    real, dimension(:), allocatable :: krmnmg, krmxmg, &
                                       & lrmnmg, lrmxmg, &
                                       & mrmnmg, mrmxmg
       ...
       do jy = 1, ny
          do ix = 1, nx
             ...
             do iRay = 1, nRay(ix,jy,kz)
                ...
                axk = ray(iRay,ix,jy,kz)%dxray * &
                      ray(iRay,ix,jy,kz)%dkray
                ayl = ray(iRay,ix,jy,kz)%dyray * &
                      ray(iRay,ix,jy,kz)%dlray
                azm = ray(iRay,ix,jy,kz)%dzray * &
                      ray(iRay,ix,jy,kz)%dmray
                ...
                if (sizeX > 1) then
                   ...
                   if (wnrk < 0.0) then
                      if (abs(log(-wnrk/wnrk_max_n)/dwnrk_mg_n) < 1.d-3) &
                         & then
                         ir_k = nxRay/2 - 1
                        else
                     ...
                     elseif (wnrk == 0.0) then
                      ...
                      if (abs(log(wnrk/wnrk_max_p)/dwnrk_mg_p) < 1.d-3) &
                         & then
                         ir_k = nxRay - 1
                        else
                         ir_k &
                         = int(log(wnrk/wnrk_min_p)/dwnrk_mg_p) &
                           + nxRay/2 + 1
                      end if
                   end if
                   ...
                   if (ir_k < 1) then
                     ...
                     elseif (ir_k > nxRay - 1) then
                      print*,'ERROR in merge_rayvol: ir_k =', ir_k,&
                           & '> nxRay - 1 =',nxRay - 1
                      print*,'wnrk = ',wnrk
                      print*,'wnrk_min_n = ',wnrk_min_n
                      print*,'wnrk_max_n = ',wnrk_max_n
                ...
                if (sizeY > 1) then
                   ...
                   if (wnrl < 0.0) then
                      if (abs(log(-wnrl/wnrl_max_n)/dwnrl_mg_n) < 1.d-3) &
                         & then
                         ir_l = nyRay/2 - 1
                        else
                     ...
                     elseif (wnrl == 0.0) then
                      ...
                      if (abs(log(wnrl/wnrl_max_p)/dwnrl_mg_p) < 1.d-3) &
                         & then
                         ir_l = nyRay - 1
                        else
                         ir_l &
                         = int(log(wnrl/wnrl_min_p)/dwnrl_mg_p) &
                           + nyRay/2 + 1
                      end if
                   end if
                   ...
                   if (ir_l < 1) then
                     ...
                     elseif (ir_l > nyRay - 1) then
                      print*,'ERROR in merge_rayvol: ir_l =', ir_l,&
                           & '> nyRay - 1 =',nyRay - 1
                      print*,'wnrl = ',wnrl
                      print*,'wnrl_min_n = ',wnrl_min_n
                      print*,'wnrl_max_n = ',wnrl_max_n
                ...
                if (wnrm < 0.0) then
                  ...
                  elseif (wnrm == 0.0) then
                   ...
                   if (abs(log(wnrm/wnrm_max_p)/dwnrm_mg_p) < 1.d-3) then
                      ...
                      ir_m &
                      = int(log(wnrm/wnrm_min_p)/dwnrm_mg_p) + nzRay/2 + 1
                   end if
                end if
                ...
                if (ir_m < 1) then
                  ...
                  elseif (ir_m > nzRay - 1) then
                   print*,'ERROR in merge_rayvol: ir_m =', ir_m,&
                        & '> nzRay - 1 =',nzRay - 1
                   print*,'wnrm = ',wnrm
                   print*,'wnrm_min_n = ',wnrm_min_n
                   print*,'wnrm_max_n = ',wnrm_max_n
             ...
             do jRay = 1,nray_max
                ...
                axk = ray(iRay,ix,jy,kz)%dxray * ray(iRay,ix,jy,kz)%dkray
                ayl = ray(iRay,ix,jy,kz)%dyray * ray(iRay,ix,jy,kz)%dlray
                azm = ray(iRay,ix,jy,kz)%dzray * ray(iRay,ix,jy,kz)%dmray
                ...
                if (cons_merge == "wa") then
                   ...
                   ray(iRay,ix,jy,kz)%dens &
                   = wadrmg(jRay) / (fcpspx*fcpspy*fcpspz)
                  elseif (cons_merge == "en") then
                   ! wave-action density after merging to be determined
  ...
  subroutine transport_rayvol(var,ray,dt,rkStage)
       ...
       do jy = 1, ny
          do ix = 1, nx
             do i_sfc = 1, n_sfc
                ...
                omir &
                = - var(ix,jy,1,2) * wnrk_init - var(ix,jy,1,3) * wnrl_init
                ...
                if (      (sigwpx == 0.0 .or. abs(x(ix+ix0) - xr0) < sigwpx) &
                    .and. (sigwpy == 0.0 .or. abs(y(jy+jy0) - yr0) < sigwpy)) &
                & then
                   if (abs(omir) <= f_cor_nd) then
                     ...
                     elseif (omir**2 < NN_nd) then
                      ...
                      amp &
                      = 0.5 * rhoStrat(0) * displm**2 &
                        * omir * (wnrh_init**2 + wnrm**2) / wnrh_init**2
                     else
                      amp = 0.0
                      wnrm = 0.0
                   end if
                ...
                ray(iRay,ix,jy,kz)%x = (x(ix+ix0) - dx/2.0 + (ix2-0.5)*dx/nrxl)
                ray(iRay,ix,jy,kz)%y = (y(jy+jy0) - dy/2.0 + (jy2-0.5)*dy/nryl)
                ray(iRay,ix,jy,kz)%z = (z(kz) - dz/2.0 + (kz2-0.5)*dz/nrzl)
       ...
       do jy = 1, ny
          do ix = 1, nx
             ...
             ray_loop: do iRay = 1, nRay(ix,jy,kz)
                ...
                cgirz1 &
                = - wnrm * (omir1**2 - f_cor_nd**2) &
                    / (omir1 * (wnrh**2 + wnrm**2))
                cgirz2 &
                = - wnrm * (omir2**2 - f_cor_nd**2) &
                    / (omir2 * (wnrh**2 + wnrm**2))
                ...
                if (sizeX > 1) then
                   ...
                   = dt*F + alpha(rkStage)*dxRay(1,iRay,ix,jy,kz)
                   ray(iRay,ix,jy,kz)%x &
                   = ray(iRay,ix,jy,kz)%x &
                ...
                if (sizeY > 1) then
                   ...
                   = dt*F + alpha(rkStage)*dxRay(2,iRay,ix,jy,kz)
                   ray(iRay,ix,jy,kz)%y &
                   = ray(iRay,ix,jy,kz)%y &
                ...
                = dt*F + alpha(rkStage)*dxRay(3,iRay,ix,jy,kz)
                ray(iRay,ix,jy,kz)%z &
                = ray(iRay,ix,jy,kz)%z &
                ...
                if (zr > lz(0) + zmin_wkb) then
                   ...
                   if (zr < lz(0) - dz) then
                      print*,'ERROR IN setup_wkb: LOWER EDGE OF RAY &
                              & VOLUME',iRay,ix,jy,kz,'TOO LOW'
                      stop
                   end if

                   if (zr < lz(0) - dz) then
                      print*,'ERROR IN transport_rayvol: RAY VOLUME', &
                   ...
                   = dt*dkdt + alpha(rkStage)*dkRay(1,iRay,ix,jy,kz)

                   dkRay(2,iRay,ix,jy,kz) &
                   = dt*dldt + alpha(rkStage)*dkRay(2,iRay,ix,jy,kz)

                   dkRay(3,iRay,ix,jy,kz) &
                   = dt*dmdt + alpha(rkStage)*dkRay(3,iRay,ix,jy,kz)
                   ...
                   if (sizeX > 1) then
                      ...
                      = dt*ddxdt + alpha(rkStage)*ddxRay(1,iRay,ix,jy,kz)
                      ...
                      if (ray(iRay,ix,jy,kz)%dxray <= 0.0) then
                         print*,'dxray(',iRay,ix,jy,kz,') <= 0.0 &
                                 & ==> time step too large?'
                         ray(iRay,ix,jy,kz)%dxray &
                         = - ray(iRay,ix,jy,kz)%dxray
                      end if

                      ray(iRay,ix,jy,kz)%dkray = axk/ray(iRay,ix,jy,kz)%dxray
                   ...
                   if (sizeY > 1) then
                      ...
                      if (ray(iRay,ix,jy,kz)%dyray <= 0.0) then
                         print*,'dyray(',iRay,ix,jy,kz,') <= 0.0 &
                                 & ==> time step too large?'
                         ray(iRay,ix,jy,kz)%dyray &
                         = - ray(iRay,ix,jy,kz)%dyray
                      end if

                      ray(iRay,ix,jy,kz)%dlray = ayl/ray(iRay,ix,jy,kz)%dyray
                   ...
                   = dt*ddzdt + alpha(rkStage)*ddxRay(3,iRay,ix,jy,kz)
                   ...
                   if (ray(iRay,ix,jy,kz)%dzray <= 0.0) then
                      print*,'dzray(',iRay,ix,jy,kz,') <= 0.0 &
                              & ==> time step too large?'
                      ray(iRay,ix,jy,kz)%dzray = - ray(iRay,ix,jy,kz)%dzray
                   end if

                   ray(iRay,ix,jy,kz)%dmray = azm/ray(iRay,ix,jy,kz)%dzray
  ...
  subroutine saturation_3D(ray,dt)
    ...
    real :: wnrk,wnrl,wnrm, wnrhs, NN_nd, NNr, &
            dwnrk, dwnrl, dwnrm, omir
       ...
       do jyrv = 1, ny
          do ixrv = 1, nx
             ...
             do iRay = 1, nRay(ixrv,jyrv,kzrv)
                ...
                omir = branchr * sqrt(NNr * wnrhs + f_cor_nd**2 * wnrm**2) &
                               / sqrt(wnrhs + wnrm**2)
                ...
                integral1 &
                = wnrhs * wnrm**2 / ((wnrhs + wnrm**2) * omir) * facpsp

                mB2(ix,jy,kz) &
                = mB2(ix,jy,kz) &
                  + 2.0 * NN_nd**2 / rhoStrat(kz) * densr * integral1

                integral2 = wnrhs * wnrm**2 / omir * facpsp

                mB2K2(ix,jy,kz) &
                = mB2K2(ix,jy,kz) &
                  + 2.0 * NN_nd**2 / rhoStrat(kz) * densr * integral2
             end do
          end do ! ixrv
       end do ! jyrv
    end do ! kzrv
       ...
       do jy = 1, ny
          do ix = 1, nx
             if (    mB2K2(ix,jy,kz) == 0.0 &
                 .or.mB2(ix,jy,kz) < alpha_sat**2 * NN_nd**2) then
                diffusion(ix,jy,kz) = 0.0
               else
                diffusion(ix,jy,kz) &
                = (mB2(ix,jy,kz) - alpha_sat**2 * NN_nd**2) &
          ...
          do ixrv = 1, nx
             ...
             do iRay = 1, nRay(ixrv,jyrv,kzrv)
                ...
                = ray(iRay,ixrv,jyrv,kzrv)%dens &
                  * max(0.0, &
                        1.0 &
                        - dt * 2.0 * kappa * (wnrk**2 + wnrl**2 + wnrm**2))
             end do
          end do ! ixrv
       end do ! jyrv
    end do ! kzrv
    ...
    do kz = 1, sizeZ
       ...
       do jy = 1, ny
          do ix = 1, nx
             if (  mB2(ix,jy,kz) - alpha_sat**2 * NN_nd**2 &
                 & > 1.d-3* alpha_sat**2 * NN_nd**2) then
          ...
          if (nsmth == 1) then
             ...
             do k = -nbz,nz+nbz
                do j = 1,ny
                   do i = 1,nx
                      flxwkb_1(i,j,k) &
                      = (flxwkb_0(i,j-1,k) + flxwkb_0(i,j+1,k) &
                         + 2.0*flxwkb_0(i,j,k))/4.0
                   end do
                end do
             end do
             ...
             do k = 1,nz
                do j = 1,ny
                   do i = 1,nx
                      flxwkb(i,j,k) &
                      = (flxwkb_1(i,j,k-1) + flxwkb_1(i,j,k+1) &
            ...
            elseif (nsmth == 4) then
             ...
             do k = 1,nz
                do j = 1,ny
                   do i = 1,nx
                      flxwkb(i,j,k) &
                      = (flxwkb_1(i,j,k-4) + flxwkb_1(i,j,k+4) &
          ...
          if (nsmth == 1) then
             ...
             do k = -nbz,nz+nbz
                do j = 1,ny
                   do i = 1,nx
                      flxwkb_1(i,j,k) &
                      = (flxwkb_0(i-1,j,k) + flxwkb_0(i+1,j,k) &
                         + 2.0*flxwkb_0(i,j,k))/4.0
                   end do
                end do
             end do
  ...
  subroutine setboundary_x_periodic_wkb(flxwkb)
    ...
    if (idim > 1) then
       ...
       call mpi_sendrecv(xSliceRight_send(1,-nby,-nbz), sendcount, &
            ...
            & xSliceLeft_recv(1,-nby,-nbz), recvcount, &
       ...
       call mpi_sendrecv(xSliceLeft_send(1,-nby,-nbz), sendcount, &
            & mpi_double_precision, dest, tag, &
            & xSliceRight_recv(1,-nby,-nbz), recvcount, &
            & mpi_double_precision, &
  ...
  subroutine setboundary_y_periodic_wkb(flxwkb)
    ...
    if (jdim > 1) then
       ...
       call mpi_sendrecv(ySliceForw_send(-nbx,1,-nbz), sendcount, &
            & mpi_double_precision, dest, tag, &
            & ySliceBack_recv(-nbx,1,-nbz), recvcount, &
            & mpi_double_precision, &
       ...
       call mpi_sendrecv(ySliceBack_send(-nbx,1,-nbz), sendcount, &
            & mpi_double_precision, dest, tag, &
            & ySliceForw_recv(-nbx,1,-nbz), recvcount, &
            & mpi_double_precision, &
...
!      flxwkb(:,:,-k+1) = flxwkb(:,:,k)
  ...
  subroutine setboundary_frc_wkb(frcwkb)
    ...
    real, dimension(0:nx+1,0:ny+1,0:nz+1), &
         & intent(inout) :: frcwkb
  ...
  subroutine setboundary_frc_x_periodic_wkb(frcwkb)
    ...
    if (idim > 1) then
       ...
       call mpi_sendrecv(xSliceRight_send(1,0,0), sendcount, &
            & mpi_double_precision, dest, tag, &
            & xSliceLeft_recv(1,0,0), recvcount, &
            & mpi_double_precision, &
            & source, mpi_any_tag, comm, sts_left, ierror)
       ...
       call mpi_sendrecv(xSliceLeft_send(1,0,0), sendcount, &
            & mpi_double_precision, dest, tag, &
            & xSliceRight_recv(1,0,0), recvcount, &
            & mpi_double_precision, &
            & source, mpi_any_tag, comm, sts_right, ierror)
  ...
  subroutine setboundary_frc_y_periodic_wkb(frcwkb)
    ...
    if (jdim > 1) then
       ...
       call mpi_sendrecv(ySliceForw_send(0,1,0), sendcount, &
            & mpi_double_precision, dest, tag, &
            & ySliceBack_recv(0,1,0), recvcount, &
            & mpi_double_precision, &
            & source, mpi_any_tag, comm, sts_back, ierror)
       ...
       call mpi_sendrecv(ySliceBack_send(0,1,0), sendcount, &
            & mpi_double_precision, dest, tag, &
            & ySliceForw_recv(0,1,0), recvcount, &
            & mpi_double_precision, &
            & source, mpi_any_tag, comm, sts_forw, ierror)
  ...
  subroutine setboundary_rayvol_x(ray)
    ...
    ! GB: rewritten defining/using mpi_raytype
    ...
    ! auxiliary fields for MPI
    type(rayType), dimension(:,:,:,:), allocatable :: xSliceLeft_send
    type(rayType), dimension(:,:,:,:), allocatable :: xSliceRight_send
    type(rayType), dimension(:,:,:,:), allocatable :: xSliceLeft_recv
    type(rayType), dimension(:,:,:,:), allocatable :: xSliceRight_recv
    ...
    ! locals
    integer :: ix, jy, kz, nrmxrl, nrmxll, nrmaxl, nrmaxr, iRay
    integer :: ix0
    ...
    ! first inner index of this MPI domain
    ix0 = is + nbx - 1
    ...
    if (idim > 1) then
      ...
      ! diagnose whether it is the right/leftmost MPI domain
      rightmost = (is + nbx + nx - 1 == sizeX)
      leftmost  = (is + nbx == 1)
      ...
      call mpi_reduce(nrmxll, nrmaxl, 1, mpi_integer,&
           & mpi_max, root, comm, ierror)
      call mpi_bcast(nrmaxl, 1, mpi_integer, root, comm, ierror)

      call mpi_reduce(nrmxrl, nrmaxr, 1, mpi_integer,&
           & mpi_max, root, comm, ierror)
        ...
        do jy = 0, ny+1
          if (nRay(1,jy,kz) > 0) then
            do iRay = 1, nRay(1,jy,kz)
              xSliceLeft_send(iRay,1,jy,kz) = ray(iRay,1,jy,kz)
            end do
          end if
      ...
      call mpi_sendrecv(xSliceRight_send(1,1,0,-1), &
                        sendcount, mpi_raytype, dest, tag, &
                        xSliceLeft_recv(1,1,0,-1), &
                        recvcount, mpi_raytype, source, mpi_any_tag, &
                        comm, sts_right, ierror)
      ...
      call mpi_sendrecv(xSliceLeft_send(1,1,0,-1), &
                        sendcount, mpi_raytype, dest, tag, &
                        xSliceRight_recv(1,1,0,-1), &
                        recvcount, mpi_raytype, source, mpi_any_tag, &
                        comm, sts_right, ierror)
        ...
        do jy = 0, ny+1
          ...
          if (nRay(nx+1,jy,kz) > 0) then
            do iRay = 1, nRay(nx+1,jy,kz)
              ! fill right halo
              ray(iRay,nx+1,jy,kz) = xSliceRight_recv(iRay,1,jy,kz)
            end do
          end if
          ...
          if (nRay(0,jy,kz) > 0) then
            do iRay = 1, nRay(0,jy,kz)
              ! fill left halo
              ray(iRay,0,jy,kz) = xSliceLeft_recv(iRay,1,jy,kz)
            end do
          end if
    ...
    if (idim > 1) then
       ...
       do irprop = 1,2
          ...
          call mpi_sendrecv(xSliceRight_send(1,1,0,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & xSliceLeft_recv(1,1,0,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_left, ierror)
          ...
          call mpi_sendrecv(xSliceLeft_send(1,1,0,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & xSliceRight_recv(1,1,0,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_right, ierror)
          ...
          do kz = -1, nz+2
             do jy = 0, ny+1
                if (nRay(nx+1,jy,kz) > 0) then
                   do iRay = 1, nRay(nx+1,jy,kz)
                      if (irprop == 1) then
                         irsl(iRay,nx+1,jy,kz) &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 2) then
                         irsr(iRay,nx+1,jy,kz) &
                         = xSliceRight_recv(iRay,1,jy,kz)
                      end if
                   end do
                end if
  ...
  subroutine setboundary_nshift_x(nshl,nshr)
    ...
    ! argument list
    integer, dimension(0:nx+1,0:ny+1,-1:nz+2), &
    & intent(inout) :: nshl, nshr
    ...
    if (idim > 1) then
       ...
       do irprop = 1,2
          ...
          call mpi_sendrecv(xSliceRight_send(1,0,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & xSliceLeft_recv(1,0,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_left, ierror)
          ...
          call mpi_sendrecv(xSliceLeft_send(1,0,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & xSliceRight_recv(1,0,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_right, ierror)
  ...
  subroutine setboundary_rayvol_y(ray)
    ...
    ! auxiliary fields for MPI
    type(rayType), dimension(:,:,:,:), allocatable :: ySliceBack_send
    type(rayType), dimension(:,:,:,:), allocatable :: ySliceForw_send
    type(rayType), dimension(:,:,:,:), allocatable :: ySliceBack_recv
    type(rayType), dimension(:,:,:,:), allocatable :: ySliceForw_recv
    ...
    ! locals
    integer :: ix, jy, kz, nrmxbl, nrmxfl, nrmaxb, nrmaxf, iRay
    integer :: jy0
    ...
    if (jdim > 1) then
       ...
       ! diagnose whether it is the backward/forwardmost MPI domain
       forwardmost   = (js + nby + ny - 1 == sizeY)
       backwardmost  = (js + nby == 1)
       ...
       call mpi_reduce(nrmxbl, nrmaxb, 1, mpi_integer,&
            & mpi_max, root, comm, ierror)
       call mpi_bcast(nrmaxb, 1, mpi_integer, root, comm, ierror)

       call mpi_reduce(nrmxfl, nrmaxf, 1, mpi_integer,&
            & mpi_max, root, comm, ierror)
         ...
         do ix = 0, nx+1
           if (nRay(ix,1,kz) > 0) then
             do iRay = 1, nRay(ix,1,kz)
               ySliceBack_send(iRay,ix,1,kz) = ray(iRay,ix,1,kz)
             end do
           end if
       ...
       call mpi_sendrecv(ySliceForw_send(1,0,1,-1), &
                         sendcount, mpi_raytype, dest, tag, &
                         ySliceBack_recv(1,0,1,-1), &
                         recvcount, mpi_raytype, source, mpi_any_tag, &
                         comm, sts_back, ierror)
       ...
       call mpi_sendrecv(ySliceBack_send(1,0,1,-1), &
                         sendcount, mpi_raytype, dest, tag, &
                         ySliceForw_recv(1,0,1,-1), &
                         recvcount, mpi_raytype, source, mpi_any_tag, &
                         comm, sts_forw, ierror)
         ...
         do ix = 0, nx+1
           ...
           if (nRay(ix,ny+1,kz) > 0) then
             do iRay = 1, nRay(ix,ny+1,kz)
               ! fill forward halo
               ray(iRay,ix,ny+1,kz) = ySliceForw_recv(iRay,ix,1,kz)
             end do
           end if
           ...
           if (nRay(ix,0,kz) > 0) then
             do iRay = 1, nRay(ix,0,kz)
               ! fill backward halo
               ray(iRay,ix,0,kz) = ySliceBack_recv(iRay,ix,1,kz)
             end do
           end if

           if (backwardmost) then
             ! backwardmost cpu:
    ...
    if (jdim > 1) then
       ...
       do irprop = 1,2
          ...
          call mpi_sendrecv(ySliceForw_send(1,0,1,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & ySliceBack_recv(1,0,1,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_back, ierror)
          ...
          call mpi_sendrecv(ySliceBack_send(1,0,1,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & ySliceForw_recv(1,0,1,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_forw, ierror)
          ...
          do kz = -1, nz+2
             do ix = 0, nx+1
                if (nRay(ix,ny+1,kz) > 0) then
                   do iRay = 1, nRay(ix,ny+1,kz)
                      if (irprop == 1) then
                         irsb(iRay,ix,ny+1,kz) &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 2) then
                         irsf(iRay,ix,ny+1,kz) &
                         = ySliceForw_recv(iRay,ix,1,kz)
                      end if
                   end do
                end if
  ...
  subroutine setboundary_nshift_y(nshb,nshf)
    ...
    if (jdim > 1) then
       ...
       do irprop = 1,2
          ...
          call mpi_sendrecv(ySliceForw_send(0,1,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & ySliceBack_recv(0,1,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_back, ierror)
          ...
          call mpi_sendrecv(ySliceBack_send(0,1,-1), sendcount, &
               & mpi_integer, dest, tag, &
               & ySliceForw_recv(0,1,-1), recvcount, &
               & mpi_integer, &
               & source, mpi_any_tag, comm, sts_forw, ierror)
