...
&domain
  ...
  sizeX = 32 !32 !32 !16 !32 !8 !64,                  ! nb of global grid cells
  sizeY = 256 !256 !128 !256 !64 !512, !FS
  sizeZ = 20 !30 !80 !240 !240,
  nbx = 2,                  ! nb. of ghost cells
  nby = 2,
  nbz = 2,
  lx_dim =    0.0, 0.5e7 ! domain lenths in m
  ly_dim =    -2.e7, 2.e7 !-2.0e7,2.0e7
...
&atmosphereList
  ...
  tpdiffhor_tropo_dim = 60.      ! tropospheric temperature difference 
                                 ...
                                 ! (used by HeldSuarez)
  ptdiffvert_tropo_dim = 50. !10.     ! vertical potential-temperature 
...
&outputList
  ...
  outputTimeDiff = 1.44e4 !3.6e3 !8.64e4 !43200.!5.e4   ! output every ... seconds
...
&baroclinic_LC
  ...
  ptptb_y_dim = 10.e6!5.e6           ! y coordinate of local 
                                ! potential-temperature perturbation (m)
