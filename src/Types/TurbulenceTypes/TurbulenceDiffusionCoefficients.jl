...
```julia
TurbulenceDiffusionCoefficients(constants::Constants)::TurbulenceDiffusionCoefficients
```
...
"""
struct TurbulenceDiffusionCoefficients{
...
function TurbulenceDiffusionCoefficients(
    ...
    return TurbulenceDiffusionCoefficients(
        km,
        kh,
        kek,
    )
