...
# Fields/Keywords
  ...
  - `next_order_impact::Bool`: Flag to include the next-order impact of gravity waves when parameterizing waves with the WKB model.
