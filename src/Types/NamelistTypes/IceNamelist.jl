...
function IceNamelist(; tau_q_sink = 3.3e2, tau_qv_source = 3.0e3, ice_setup = NoIce(), dt_ice = 1.0, nscx = 1, nscy = 1, nscz = 1, cloudcover= CloudCoverOff(), parameterized_nucleation = false, parameterized_sgs_q = false, constant_advection = false, hor_adv_vel = (0.0, 0.0), ice_test_case = NoIceTestCase())
