...
u, v, w = state.variables.predictands.u, .v, .w
rho, p = state.variables.predictands.rho, .p
...
See also: [`Namelists`](@ref), [`Variables`](@ref), [`Grid`](@ref), [`Poisson`](@ref)
"""
struct State{
    A <: Namelists,
    B <: Time,
