...
&domain
  ...
  nby = 2,
  nbz = 2,
  lx_dim =    0., 48000000. ! domain lenths in m
  ly_dim =   0, 160000.!-1.5e7, 1.5e7!-2.e7, 2.e7
  lz_dim =    0.0,  10000.
...
&outputList
  ...
  outputTimeDiff =  480000.   ! output every ... seconds
  maxTime =  480000.           ! stop after maxTime seconds
