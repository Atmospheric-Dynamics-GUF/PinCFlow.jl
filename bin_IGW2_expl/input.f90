...
&domain
  ...
  nby = 2,
  nbz = 2,
  lx_dim =    0., 6000000.!0., 6000000. ! domain lenths in m
...
&solverList
  ...
  dtMax_dim = 10000!3600               ! max time step in s
  ...
  shap_dts_fac = 0.!5.e3 !0. !5.e3             ! horizontal-Shapro-filter damping time 
