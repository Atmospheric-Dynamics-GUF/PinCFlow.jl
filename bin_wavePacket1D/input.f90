...
&outputList
  ...
  outputTimeDiff = 900.  ! output every ... seconds
  maxTime        = 9000.  ! stop after maxTime seconds
...
&wavePacket
  ...
  lambdaX_dim = 1000.      ! wave length in x direction in m
  ...
  L_cos_dim = 0.0      ! half width of vertical cosine profile of GWP
  ...
  L_jet_dim  = 0.0      ! half width vertical cosine profile of jet in 1m
  z0_jet_dim = 0.0    ! center of jet stream
