...
d_nam=${d_home}/bin_wavePacket2D
fp_exe=${d_home}/bin_wavePacket2D/pinc
d_work=${d_scratch}/wavePacket2D_640_si_cfl0.1667_nL_shapiro1.5h_DyTurbScheme
