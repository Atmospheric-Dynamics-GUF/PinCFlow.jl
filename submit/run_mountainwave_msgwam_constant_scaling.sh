...
#SBATCH --job-name=mountainwave_msgwam_constant_scaling
#SBATCH --ntasks=32
...
dirWork=${dirScratch}/pinc/mountainwave_msgwam_constant_scaling
...
sed -e "s/{nprocx}/${nprocx}/" \
    -e "s/{nprocy}/${nprocy}/" \
        ${dirNam}/input_mountainwave_msgwam_constant_scaling.f90 > input.f90
