...
dirWork=${dirScratch}/pincflow_tfc_semi_implicit_boussinesq/efficiency_bq
...
sed -e "s/{nprocx}/${nprocx}/" \
    -e "s/{nprocy}/${nprocy}/" \
        ${dirNam}/input_efficiency_bq.f90 > input.f90
...
dirWork=${dirScratch}/pincflow_tfc_semi_implicit_boussinesq/efficiency_si_bq
...
sed -e "s/{nprocx}/${nprocx}/" \
    -e "s/{nprocy}/${nprocy}/" \
        ${dirNam}/input_efficiency_si_bq.f90 > input.f90
