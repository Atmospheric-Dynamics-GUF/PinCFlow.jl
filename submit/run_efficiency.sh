...
dirWork=${dirScratch}/pincflow_tfc_semi_implicit_boussinesq/efficiency
...
sed -e "s/{nprocx}/${nprocx}/" \
    -e "s/{nprocy}/${nprocy}/" \
        ${dirNam}/input_efficiency.f90 > input.f90
...
dirWork=${dirScratch}/pincflow_tfc_semi_implicit_boussinesq/efficiency_si
...
sed -e "s/{nprocx}/${nprocx}/" \
    -e "s/{nprocy}/${nprocy}/" \
        ${dirNam}/input_efficiency_si.f90 > input.f90
