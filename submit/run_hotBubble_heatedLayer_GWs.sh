...
d_nam=${d_home}/bin_hotBubble_heatedLayer_GWs
fp_exe=${d_home}/bin_hotBubble_heatedLayer_GWs/pinc
d_work=${d_scratch}/hotBubble_heatedLayer_GWs_dtfix0.2_si
