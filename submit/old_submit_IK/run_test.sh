...
dirHome=/home/atmodynamics/knop
dirScratch=/scratch/atmodynamics/knop

dirNam=${dirHome}/pinc-flow-tracer/input
exe=${dirHome}/pinc-flow-tracer/bin/pinc
dirWork=${dirScratch}/output/test
...
sed -e "s/{nprocx}/${nprocx}/" \
    -e "s/{nprocy}/${nprocy}/" \
        ${dirNam}/input_test.f90 > input.f90
