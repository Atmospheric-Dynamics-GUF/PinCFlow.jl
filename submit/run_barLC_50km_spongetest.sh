...
d_nam=${d_home}/bin_barLC_50km_spongetest
fp_exe=${d_home}/bin_barLC_50km_spongetest/pinc
d_work=${d_scratch}/barLC_50km_HS94_sponge0.5+fluxesoutput_shap1.5h
