...
&domain
  sizeX                      =                     128 ! Cells in x
  sizeY                      =                      32 ! Cells in y
  sizeZ                      =                     128 ! Cells in z
  nbx                        =                       3 ! Halo/ghost cells in x
  nby                        =                       3 ! Halo/ghost cells in y
  nbz                        =                       3 ! Ghost cells in z
  lx_dim(0)                  =                 -4.0E+3 ! Minimum of x
  lx_dim(1)                  =                  4.0E+3 ! Maximum of x
  ly_dim(0)                  =                 -4.0E+3 ! Minimum of y
  ly_dim(1)                  =                  4.0E+3 ! Maximum of y
  lz_dim(0)                  =                  0.0E+0 ! Minimum of z
  lz_dim(1)                  =                  8.0E+3 ! Maximum of z
...
&outputList
  ...
  nOutput                    =                       1 ! Output every nOutput
                                                       ...
                                                       ! outputType =
                                                       ! 'timeStep'
  maxIter                    =                      10 ! Stop after maxIter
                                                       ! time steps for
                                                       ! outputType =
                                                       ! 'timeStep'
  outputTimeDiff             =                  3.0E+1 ! Output every
                                                       ! outputTimeDiff seconds
                                                       ! for outputType =
                                                       ! 'time'
  maxTime                    =                  1.2E+3 ! Stop after maxTime
...
&testCaseList
  testCase                   =           'hotBubble3D' ! Predefined test case
&end
...
&LagrangeRayTracing
  ...
  yrmin_dim                  =                  0.0E+0 ! Backward bound of
                                                       ! initial rays
  yrmax_dim                  =                  4.0E+4 ! Forward bound of
                                                       ! initial rays
...
&solverList
  ...
  dtMax_dim                  =                  3.6E+3 ! Maximum time step
...
&atmosphereList
  ...
  theta_tr_dim               =                  2.4E+2 ! Potential temperature
                                                       ! in troposphere
