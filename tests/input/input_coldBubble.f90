...
&domain
  ...
  lx_dim(0)                  =                -2.56E+4 ! Minimum of x
  lx_dim(1)                  =                 2.56E+4 ! Maximum of x
  ly_dim(0)                  =                  0.0E+0 ! Minimum of y
  ly_dim(1)                  =                  2.5E+1 ! Maximum of y
  lz_dim(0)                  =                  0.0E+0 ! Minimum of z
  lz_dim(1)                  =                  6.4E+3 ! Maximum of z
...
&outputList
  ...
  maxIter                    =                       5 ! Stop after maxIter
                                                       ...
                                                       ! outputType =
                                                       ! 'timeStep'
  outputTimeDiff             =                  3.0E+2 ! Output every
                                                       ! outputTimeDiff seconds
                                                       ! for outputType =
                                                       ! 'time'
  maxTime                    =                  9.0E+2 ! Stop after maxTime
...
&testCaseList
  testCase                   =            'coldBubble' ! Predefined test case
&end
...
&solverList
  ...
  dtMax_dim                  =                  4.0E+0 ! Maximum time step
  ...
  turb_dts                   =      3.3333333333333E+1 ! Turbulent damping time
...
&atmosphereList
  ...
  background                 =            'isentropic' ! 'realistic',
                                                       ! 'isothermal',
                                                       ! 'isentropic', 'const-
                                                       ! N', 'diflapse' or
                                                       ! 'HeldSuarez'
