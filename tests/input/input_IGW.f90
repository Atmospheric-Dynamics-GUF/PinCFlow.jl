...
&outputList
runName                  =                   'IGW' ! run name for netCDF file
atmvarOut(1)             =                'thetap' ! Atmospheric output
                                                   ! variable
...
nOutput                  =                       1 ! Output every nOutput
                                                   ! time steps for
                                                   ! outputType = 'timeStep'
maxIter                  =                       5 ! Stop after maxIter time
...
maxTime                  =                  3.0E+3 ! Stop after maxTime
                                                   ...
                                                   ! 'time'
iIn                      =                      23 ! restart at time-step iIn
...
sponge_uv                =                       F ! Sponge layer for
                                                   ! horizontal wind if
                                                   ! unifiedSponge = .false.
spongeHeight             =                  3.0E-1 ! Relative height of lower
                                                   ! sponge layer edge (scale
                                                   ! height for unifiedSponge
                                                   ! = .true. and spongeType
                                                   ! = 'exponential')
spongeAlphaZ_dim         =                  1.4E-4 ! Maximum relaxation rate
                                                   ! for unifiedSponge =
                                                   ! .true.
