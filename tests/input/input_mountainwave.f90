...
&outputList
  ...
  nOutput                    =                       1 ! Output every nOutput
                                                       ...
                                                       ! outputType =
                                                       ! 'timeStep'
  maxIter                    =                   10000 ! Stop after maxIter
                                                       ! time steps for
                                                       ! outputType =
                                                       ! 'timeStep'
  outputTimeDiff             =                  5.0E+0 ! Output every
...
&solverList
  cfl                        =                  4.0E-1 ! CFL number
  cfl_wave                   =                  5.0E-1 ! WKB CFL number
  dtMax_dim                  =                  5.0E+0 ! Maximum time step
  tStepChoice                =                   'fix' ! 'fix' or 'cfl'
...
&boundaryList
  ...
  sponge_uv                  =                       F ! Sponge layer for
                                                       ...
                                                       ! unifiedSponge =
                                                       ! .false.
  spongeHeight               =                  5.0E-1 ! Relative height of
                                                       ! lower sponge layer
                                                       ! edge (scale height for
                                                       ! unifiedSponge = .true.
                                                       ! and spongeType =
                                                       ! 'exponential')
  spongeAlphaZ_dim           =                  1.0E-2 ! Maximum relaxation
                                                       ! rate for unifiedSponge
                                                       ! = .true.
  spongeAlphaZ_fac           =                  1.0E+0 ! Sponge layer factor
                                                       ! for unifiedSponge =
                                                       ! .false.
  unifiedSponge              =                       T ! Unified sponge for
                                                       ! both time schemes,
                                                       ! applied to wind and
                                                       ! density
