...
atmvarOut(1)             =                   'rho' ! output variable
atmvarOut(2)             =                     'u' ! output variable
atmvarOut(3)             =                     'v' ! output variable
atmvarOut(4)             =                     'w' ! output variable
atmvarOut(5)             =                    'pi' ! output variable
outputType               =                  'time' ! 'timeStep' or 'time'
nOutput                  =                       1 ! Output every nOutput
                                                   ! time steps for
                                                   ! outputType = 'timeStep'
maxIter                  =                   10000 ! Stop after maxIter time
...
restart                  =                       F ! Restart the model from
                                                   ! state in previous
                                                   ! simulation
restartIN(1)             =                   'rho' ! restart variable
restartIN(2)             =                    'us' ! restart variable
restartIN(3)             =                    'vs' ! restart variable
restartIN(4)             =                    'ws' ! restart variable
...
&modelList
model                    =          'compressible' ! Dynamic equations
