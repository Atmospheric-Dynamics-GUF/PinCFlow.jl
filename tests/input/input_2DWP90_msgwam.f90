...
atmvarOut(3)             =                     'w' ! Atmospheric output
                                                   ! variable
atmvarOut(4)             =                  'tmrd' ! Atmospheric output
                                                   ! variable
atmvarOut(5)             =                  'rhop' ! Atmospheric output
                                                   ! variable
...
maxTime                  =                  9.0E+4 ! Stop after maxTime
                                                   ...
                                                   ! 'time'
saverayvols              =                       F ! Save ray volumes at last
                                                   ! time step
iIn                      =                      -1 ! restart at time-step iIn
restart                  =                       F ! Restart the model from
                                                   ! state in previous
                                                   ! simulation
restartIN(1)             =                    'us' ! Restart input variable
restartIN(2)             =                    'vs' ! Restart input variable
restartIN(3)             =                    'ws' ! Restart input variable
restartIN(4)             =                  'tmrd' ! Restart input variable
restartIN(5)             =                  'rhop' ! Restart input variable
...
lambdaX_dim              =                  1.0E+3 ! Wavelength in x (0.0 for
                                                   ! infinite wavelength)
...
yrmin_dim                =                  0.0E+0 ! Backward bound of
                                                   ! initial rays
yrmax_dim                =                  3.0E+5 ! Forward bound of initial
                                                   ! rays
zrmin_dim                =                  0.0E+0 ! Bottom bound of initial
                                                   ! rays
zrmax_dim                =                  1.0E+5 ! Top bound of initial rays
nrxl                     =                       4 ! Initial ray volumes
                                                   ! within dx
nryl                     =                       1 ! Initial ray volumes
                                                   ! within dy
nrzl                     =                       4 ! Initial ray volumes
                                                   ! within dz
...
amp_wkb                  =                  5.0E-1 ! Relative amplitude of
                                                   ! wave packet
wlrx_init                =                  0.0E+0 ! Wavelength in x of wave
                                                   ! packet
wlry_init                =                  3.0E+5 ! Wavelength in y of wave
                                                   ! packet
