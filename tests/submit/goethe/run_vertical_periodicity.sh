...
#SBATCH --job-name=vertical_periodicity
#SBATCH --ntasks=128
...
dirWork=${dirScratch}/pincflow_tfc_semi_implicit_boussinesq/tests/vertical_periodicity
...
sed -e "s/{nprocx}/${nprocx}/" \
    -e "s/{nprocy}/${nprocy}/" \
        ${dirNam}/input_vertical_periodicity.f90 > input.f90
