          ...
          do j=1,ny
             ...
             do k = 2, nz-ceiling((spongeHeight+spongeHeight/3.)*real(nz)) !nz+1 !FS
                do i=1,nx
                   ...
                   if (k == nz-ceiling((spongeHeight+spongeHeight/3.)*real(nz)))then
                      tp_sponge(i,j) = the_env_pp(i,j,k)*var(i,j,k,5)
             ...
             do k = nz-ceiling((spongeHeight+spongeHeight/3.)*real(nz)), nz+1 !FS
                do i=1,nx
                   pistar &
                   = var(i,j,k-2,5) - 2.0*dz * kappa/the_env_pp(i,j,k-1)
