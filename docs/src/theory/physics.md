...
$$\begin{align*}
    \widehat{z} & = \widehat{z} \left(\tilde{z}\right), & \left(\widehat{x}, \widehat{y}, \tilde{z}\right) & = \left(x, y, L_z \frac{z - h}{L_z - h}\right), &  \left(x, y, z\right) & = \left(\widehat{x}, \widehat{y}, \frac{L_z - h}{L_z}{\tilde{z}} + h\right),
\end{align*}$$
...
$$\begin{align*}
    \boldsymbol{\epsilon}^{\widehat{x}} & = \boldsymbol{e}^x, & \boldsymbol{\epsilon}^{\widehat{y}} & = \boldsymbol{e}^y, & \boldsymbol{\epsilon}^{\widehat{z}} = \frac{\partial h}{\partial \widehat{x}} \frac{\tilde{z} - L_z}{L_z - h} \frac{\partial \widehat{z}}{\partial \tilde{z}} \boldsymbol{e}^x + \frac{\partial h}{\partial y} \frac{\tilde{z} - L_z}{L_z - h} \frac{\partial \widehat{z}}{\partial \tilde{z}} \boldsymbol{e}^y + \frac{L_z}{L_z - h} \frac{\partial \widehat{z}}{\partial \tilde{z}}\boldsymbol{e}^z.
\end{align*}$$

The scalar products of these yield the metric tensor

$$G^{\mu \nu} = \begin{pmatrix}
    1 & 0 & \frac{\partial h}{\partial x} \frac{\tilde{z} - L_z}{L_z - h} \frac{\partial \widehat{z}}{\partial \tilde{z}}\\
    0 & 1 & \frac{\partial h}{\partial y} \frac{\tilde{z} - L_z}{L_z - h} \frac{\partial \widehat{z}}{\partial \tilde{z}}\\
    \frac{\partial h}{\partial x} \frac{\tilde{z} - L_z}{L_z - h} \frac{\partial \widehat{z}}{\partial \tilde{z}} & \frac{\partial h}{\partial y} \frac{\tilde{z} - L_z}{L_z - h} \frac{\partial \widehat{z}}{\partial \tilde{z}} & \left\{\left(\frac{L_z}{L_z - h}\right)^2 + \left(\frac{\tilde{z} - L_z}{L_z - h}\right)^2 \left[\left(\frac{\partial h}{\partial x}\right)^2 + \left(\frac{\partial h}{\partial y}\right)^2\right]\right\} \left(\frac{\partial \widehat{z}}{\partial \tilde{z}}\right)^2
\end{pmatrix},$$

from which the Jacobian

$$J = \frac{L_z - h} {L_z} \frac{\partial \tilde{z}}{\partial \widehat{z}}$$
