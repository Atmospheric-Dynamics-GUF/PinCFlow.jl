...
&grid
  ...
  nx = 40,             ! nb of grid internal cells 
  ny = 1,               ! max 40^3 or 170^2 on acerix with csr storage
  nz = 800,              ! at least nz = 3!
  nbx = 3,              ! nb. of ghost cells
  nby = 3,
  nbz = 3,
  lx_dim = -1500.0, 1500.0,       ! domain lenths in m
  ly_dim = 0.0, 60000.0, 
  lz_dim = 0.0, 60000.0,
...
&solverList
  ...
  fluxType   = "ILES"           ! ILES / central / upwind
  reconstType = "SALD"           ! MUSCL / constant / SALD / ALDM
...
&outputList
  ...
  solutionTime = .false.     ! TECPLOT's "solution time" out yes/no
