...
!       beta(i,k) = 1.0
    ...
    do lambda2 = l0,l1,2
       i_loop2: do i = 3, n-2
          ...
          r = 0
          omega(r,i,k,lambda2) = third * gamma(k,r,lambda2)*beta(i+1,k) / sSum
          r = 1
          omega(r,i,k,lambda2) = third * gamma(k,r,lambda2)*beta(i,k) / sSum
       end do i_loop2
    end do
...
!       beta(i,k) = 1.0
    ...
    do lambda2 = l0,l1,2
       i_loop3: do i = 3, n-2
          ...
          do r = 0, k-1
             omega(r,i,k,lambda2) = third * gamma(k,r,lambda2) * &
                  & beta(i+2-r,k) / sSum
          end do
       end do i_loop3
    end do
...
print*,"xweno.f90/reconstruct1D_old: phiBarX(n/2,n/2+1) = ", &
     & n/2,n/2+1,phiBar(n/2), phiBar(n/2+1)
       ...
       do k = 1,3
          do r = 0,k-1
             do lambda2 = l0,l1,2
                ...
                omega(k,r,lambda2) = 1.0/3.0 * beta(k,r)/sSum * gamma(k,r,lambda2)
