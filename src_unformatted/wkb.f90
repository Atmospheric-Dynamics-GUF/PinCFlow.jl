       ...
       do jy = 1, ny
          do ix = 1, nx
             ...
             do jRay = 1,nray_max
                ...
                ray(iRay,ix,jy,kz)%area_yl &
                = ray(iRay,ix,jy,kz)%dyray * ray(iRay,ix,jy,kz)%dlray

                ray(iRay,ix,jy,kz)%area_zm &
                = ray(iRay,ix,jy,kz)%dzray * ray(iRay,ix,jy,kz)%dmray
...
!      flxwkb(:,:,-k+1) = flxwkb(:,:,k)
                   ...
                   do iRay = 1, nRay(1,jy,kz)
                      if (irprop == 1) then
                        ...
                        elseif (irprop == 7) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%omega
                        elseif (irprop == 8) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%dkray
                        elseif (irprop == 9) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%dlray
                        elseif (irprop == 10) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%dmray
                        elseif (irprop == 11) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%dxray
                        elseif (irprop == 12) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%dyray
                        elseif (irprop == 13) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%dzray
                        elseif (irprop == 14) then
                         xSliceLeft_send (iRay,1,jy,kz) &
                         = ray(iRay,1,jy,kz)%dens
                ...
                if (nRay(nx,jy,kz) > 0) then
                   do iRay = 1, nRay(nx,jy,kz)
                      if (irprop == 1) then
                        ...
                        elseif (irprop == 7) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%omega
                        elseif (irprop == 8) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%dkray
                        elseif (irprop == 9) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%dlray
                        elseif (irprop == 10) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%dmray
                        elseif (irprop == 11) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%dxray
                        elseif (irprop == 12) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%dyray
                        elseif (irprop == 13) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%dzray
                        elseif (irprop == 14) then
                         xSliceRight_send(iRay,1,jy,kz) &
                         = ray(iRay,nx,jy,kz)%dens
                        !elseif (irprop == 15) then
                        ! xSliceRight_send(iRay,1,jy,kz) &
             ...
             do jy = 0, ny+1
                if (nRay(nx+1,jy,kz) > 0) then
                   do iRay = 1, nRay(nx+1,jy,kz)
                      if (irprop == 1) then
                         ray(iRay,nx+1,jy,kz)%x &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 2) then
                         ray(iRay,nx+1,jy,kz)%y &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 3) then
                         ray(iRay,nx+1,jy,kz)%z &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 4) then
                         ray(iRay,nx+1,jy,kz)%k &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 5) then
                         ray(iRay,nx+1,jy,kz)%l &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 6) then
                         ray(iRay,nx+1,jy,kz)%m &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 7) then
                         ray(iRay,nx+1,jy,kz)%omega &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 8) then
                         ray(iRay,nx+1,jy,kz)%dkray &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 9) then
                         ray(iRay,nx+1,jy,kz)%dlray &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 10) then
                         ray(iRay,nx+1,jy,kz)%dmray &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 11) then
                         ray(iRay,nx+1,jy,kz)%dxray &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 12) then
                         ray(iRay,nx+1,jy,kz)%dyray &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 13) then
                         ray(iRay,nx+1,jy,kz)%dzray &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        elseif (irprop == 14) then
                         ray(iRay,nx+1,jy,kz)%dens &
                         = xSliceRight_recv(iRay,1,jy,kz)
                        !elseif (irprop == 15) then
                   ...
                   do iRay = 1, nRay(0,jy,kz)
                      if (irprop == 1) then
                        ...
                        elseif (irprop == 10) then
                         ...
                         =  xSliceLeft_recv(iRay,1,jy,kz)
                        elseif (irprop == 11) then
                         ray(iRay,0,jy,kz)%dxray &
                         =  xSliceLeft_recv(iRay,1,jy,kz)
                        elseif (irprop == 12) then
                         ray(iRay,0,jy,kz)%dyray &
                         =  xSliceLeft_recv(iRay,1,jy,kz)
                        elseif (irprop == 13) then
                         ray(iRay,0,jy,kz)%dzray &
                         =  xSliceLeft_recv(iRay,1,jy,kz)
                        elseif (irprop == 14) then
                         ray(iRay,0,jy,kz)%dens &
                         =  xSliceLeft_recv(iRay,1,jy,kz)
                        !elseif (irprop == 15) then
  ...
  subroutine setboundary_rayvol_y(ray)
    ...
    ! auxiliary fields
    real, dimension(:,:,:,:), allocatable :: ySliceBack_send, &
                                           & ySliceForw_send
    real, dimension(:,:,:,:), allocatable :: ySliceBack_recv, &
                                           & ySliceForw_recv
                ...
                if (nRay(ix,1,kz) > 0) then
                   do iRay = 1, nRay(ix,1,kz)
                      if (irprop == 1) then
                        ...
                        elseif (irprop == 7) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%omega
                        elseif (irprop == 8) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%dkray
                        elseif (irprop == 9) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%dlray
                        elseif (irprop == 10) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%dmray
                        elseif (irprop == 11) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%dxray
                        elseif (irprop == 12) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%dyray
                        elseif (irprop == 13) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%dzray
                        elseif (irprop == 14) then
                         ySliceBack_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,1,kz)%dens
                        !elseif (irprop == 15) then
                        ! ySliceBack_send(iRay,ix,1,kz) &
                ...
                if (nRay(ix,ny,kz) > 0) then
                   do iRay = 1, nRay(ix,ny,kz)
                      if (irprop == 1) then
                        ...
                        elseif (irprop == 7) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%omega
                        elseif (irprop == 8) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%dkray
                        elseif (irprop == 9) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%dlray
                        elseif (irprop == 10) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%dmray
                        elseif (irprop == 11) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%dxray
                        elseif (irprop == 12) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%dyray
                        elseif (irprop == 13) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%dzray
                        elseif (irprop == 14) then
                         ySliceForw_send(iRay,ix,1,kz) &
                         = ray(iRay,ix,ny,kz)%dens
                        !elseif (irprop == 15) then
                        ! ySliceForw_send(iRay,ix,1,kz) &
             ...
             do ix = 0, nx+1
                if (nRay(ix,ny+1,kz) > 0) then
                   do iRay = 1, nRay(ix,ny+1,kz)
                      if (irprop == 1) then
                         ray(iRay,ix,ny+1,kz)%x &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 2) then
                         ray(iRay,ix,ny+1,kz)%y &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 3) then
                         ray(iRay,ix,ny+1,kz)%z &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 4) then
                         ray(iRay,ix,ny+1,kz)%k &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 5) then
                         ray(iRay,ix,ny+1,kz)%l &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 6) then
                         ray(iRay,ix,ny+1,kz)%m &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 7) then
                         ray(iRay,ix,ny+1,kz)%omega &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 8) then
                         ray(iRay,ix,ny+1,kz)%dkray &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 9) then
                         ray(iRay,ix,ny+1,kz)%dlray &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 10) then
                         ray(iRay,ix,ny+1,kz)%dmray &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 11) then
                         ray(iRay,ix,ny+1,kz)%dxray &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 12) then
                         ray(iRay,ix,ny+1,kz)%dyray &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 13) then
                         ray(iRay,ix,ny+1,kz)%dzray &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        elseif (irprop == 14) then
                         ray(iRay,ix,ny+1,kz)%dens &
                         = ySliceForw_recv(iRay,ix,1,kz)
                        !elseif (irprop == 15) then
                   ...
                   do iRay = 1, nRay(ix,0,kz)
                      if (irprop == 1) then
                        ...
                        elseif (irprop == 10) then
                         ...
                         = ySliceBack_recv(iRay,ix,1,kz)
                        elseif (irprop == 11) then
                         ray(iRay,ix,0,kz)%dxray &
                         = ySliceBack_recv(iRay,ix,1,kz)
                        elseif (irprop == 12) then
                         ray(iRay,ix,0,kz)%dyray &
                         = ySliceBack_recv(iRay,ix,1,kz)
                        elseif (irprop == 13) then
                         ray(iRay,ix,0,kz)%dzray &
                         = ySliceBack_recv(iRay,ix,1,kz)
                        elseif (irprop == 14) then
                         ray(iRay,ix,0,kz)%dens &
                         = ySliceBack_recv(iRay,ix,1,kz)
                        !elseif (irprop == 15) then
