...
# srun --cpu_bind=verbose --distribution=block:cyclic julia --project examples/submit/mountain_wave.jl 1>mountain_wave.log 2>&1

# Run the model on interactive partition.
mpiexec -n 64 julia --project examples/submit/mountain_wave.jl 1>mountain_wave.log 2>&1
