...
# srun --cpu_bind=verbose --distribution=block:cyclic julia --project examples/submit/wkb_mountain_wave.jl 1>wkb_mountain_wave.log 2>&1

# Run the model on interactive partition.
mpiexec -n 64 julia --project examples/submit/wkb_mountain_wave.jl 1>wkb_mountain_wave.log 2>&1
