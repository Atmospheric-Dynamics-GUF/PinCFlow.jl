...
# srun --cpu_bind=verbose --distribution=block:cyclic julia examples/submit/vortex.jl 4 4 1>vortex.log 2>&1

# Run the model on interactive partition.
mpiexec -n 16 julia examples/submit/vortex.jl 4 4 1>vortex.log 2>&1
