...
srun --cpu_bind=verbose julia --project=${project_dir} examples/scripts/wkb_mountain_wave.jl 8 1 8 1>wkb_mountain_wave_${RUN}.log 2>&1
...
#mpiexec -n 64 julia --project=${project_dir} examples/scripts/wkb_mountain_wave.jl 8 1 8 1>wkb_mountain_wave_${RUN}.log 2>&1
