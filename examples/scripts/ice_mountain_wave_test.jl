...
# save sbatch script copy and ice_mountain_wave_test.jl to output directory
MPI.Init()
if MPI.Comm_rank(MPI.COMM_WORLD) == 0
    output_dir = dirname(outfile)
    sbatch_src = "/home/b/b383844/PinCFlow/PinCFlow.jl/examples/scripts/levante/ice_dump.sh"
    sbatch_dst = "/work/bb1097/b383844/PinCFlow/batch/ice_dump_ice_mountain_wave_test.sbatch"
    cp(sbatch_src, sbatch_dst; force=true)
    script_src = "/home/b/b383844/PinCFlow/PinCFlow.jl/examples/scripts/ice_mountain_wave_test.jl"
    script_dst = "/work/bb1097/b383844/PinCFlow/julia/ice_mountain_wave_test.jl"
