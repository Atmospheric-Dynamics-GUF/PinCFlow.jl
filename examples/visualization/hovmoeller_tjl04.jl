...
tidx = 1 # length(data["w"][1, 1, 1, :])  # for a 4D array, 4th dimension is often "time"
...
#fld2 = data2.group["icevar"]["sn"][:, :, :, :]
fld2 = data2.group["icevar"]["sqv"][:, :, :, :]
...
ax1.plot(xvals, fld2[:,iy,iz], "k--", label="fld")
