...
&solverList
  ...
  cfl = 0.1667!0.9
  cfl_wave = 0.1667!5             ! passage rate of phase throuh a cell
  dtMax_dim = 100.               ! max time step in s
  ...
  shap_dts_fac = 5.4e3!0.01               ! horizontal-Shapro-filter damping time 
                                  ! scale 
...
&boundaryList
  ...
  spongeHeight = 0.166666     ! relative height of sponge layer
  spongeAlphaZ_dim = 1.e-3 ! relaxation rate coeff in 1/s
&end
...
&outputList
  ...
  outputTimeDiff = 600.  ! output every ... seconds
  maxTime        = 3600.  ! stop after maxTime seconds
...
&wavePacket
  ...
  lambdaX_dim = 4000.      ! wave length in x direction in m
                          ! lambdaX = 0.0 --> infinite wavelength
  lambdaY_dim = 0.      ! wave length in y direction in m
                          ! lambday = 0.0 --> infinite wavelength
  lambdaZ_dim = -4000.0   ! vertical wave length in m

  amplitudeFactor = 0.9   ! normalilized buoyancy amplitude

  xCenter_dim = 2.e4   ! center of wave packet in x direction in m

  yCenter_dim = 0.!1.5e5     ! center of wave packet in y direction in m
  zCenter_dim = 2.e4      ! center of wave packet in z direction in m

  sigma_dim = 5000.0      ! vertical width of Gaussian wavepacket in m

  sigma_hor_dim = 10000.   ! cosine distribution width 
                          ! (in x direction, 0 means infinity)
  sigma_hor_yyy_dim = 0.!1.5e6  ! cosine distribution width 
  ...
  amp_mod_y = 0.!1.0         ! fractional amplitude of amplitude modulation 
                          ! in y direction
                          ! (0 = no modulation, 1 = total modulation)
  ...
  z0_jet_dim = 5000.0    ! center of jet stream
