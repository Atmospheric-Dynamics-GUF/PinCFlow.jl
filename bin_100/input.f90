...
&domain
  ...
  nby = 2,
  nbz = 2,
  lx_dim =    -25.6e3, 25.6e3 ! domain lenths in m
  ly_dim =   0, 25.!-1.5e7, 1.5e7!-2.e7, 2.e7
  lz_dim =    0.0, 6400.
...
&solverList
  ...
  dtMax_dim =  8!1000!3600               ! max time step in s
...
! shap_dts_fac = 5.               ! horizontal-Shapro-filter damping time 
  ...
  turb_dts = 133.333333333333!5.e3            ! (s) turbulent damping time scale for the 
...
&outputList
  ...
  outputTimeDiff =  300.   ! output every ... seconds
  maxTime =  900.           ! stop after maxTime seconds
